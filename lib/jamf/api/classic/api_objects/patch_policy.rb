...
module Jamf
  ...
  #
  # See {Jamf::PatchTitle} and {Jamf::PatchSource.available_titles} for methods
  # to acquire such info.
  #
  # @see Jamf::APIObject
  #
  class PatchPolicy < Jamf::APIObject
    ...
    # a Jamf::PatchTitle or the name or id of one
    #
    ...
    def validate_target_version(tgt_vers)
      raise Jamf::MissingDataError, "target_version can't be nil" unless tgt_vers

      Jamf::Validate.non_empty_string tgt_vers

      unless patch_title(:refresh).versions.key? tgt_vers
        errmsg = "Version '#{tgt_vers}' does not exist for title: #{patch_title_name}."
        raise Jamf::NoSuchItemError, errmsg
      end
      ...
      raise Jamf::UnsupportedError, errmsg
    end
