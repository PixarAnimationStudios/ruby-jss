...
module Jamf
  ...
  # these JSON objects.
  #
  # Jamf::JSONObject is a base class that provides a way to convert those JSON
  ...
  # or a reference to a building. These are clearly defined in the OAPI schema
  # defining the Jamf Pro API.
  #
  ...
  # the base class Jamf::Resource, and all resources must define a RSRC_VERSION
