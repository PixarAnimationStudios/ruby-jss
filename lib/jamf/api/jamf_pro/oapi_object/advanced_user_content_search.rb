...
module Jamf
  ...
  class OAPIObject
    ...
    # of their attributes.
    #  - Jamf::OAPIObject::AdvancedUserContentSearchSearchResults
    #
    # Sub Objects:
    # Other object models used by this model's attributes.
    #  - Jamf::OAPIObject::SmartSearchCriterion
    #
    ...
    class AdvancedUserContentSearch < OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute criteria
        #   @return [Array<Jamf::OAPIObject::SmartSearchCriterion>]
        criteria: {
          class: Jamf::OAPIObject::SmartSearchCriterion,
          multi: true
        },
