...
module Jamf
  ...
  class OAPIObject
    ...
    # OAPI Object Model and Enums for: GetComputerPrestage
    #
    #
    #
    ...
    # of their attributes.
    #  - Jamf::OAPIObject::ComputerPrestageSearchResults
    #
    # Sub Objects:
    ...
    class GetComputerPrestage < OAPIObject
      ...
      }.merge(Jamf::OAPIObject::ComputerPrestage::OAPI_PROPERTIES) # end OAPI_PROPERTIES

    end # class GetComputerPrestage
