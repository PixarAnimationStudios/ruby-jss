...
module Jamf
  ...
  class OAPIObject
    ...
    #  - '/v1/cloud-ldaps/defaults/mappings:GET' needs permissions:
    #    - Read LDAP Servers
    #  - '/v1/cloud-ldaps/{id}/mappings:GET' needs permissions:
    #    - Read LDAP Servers
    #  - '/v1/cloud-ldaps/{id}/mappings:PUT' needs permissions:
    #    - Update LDAP Servers
