...
module Jamf
  ...
  class OAPIObject
    ...
    # of their attributes.
    #  - Jamf::OAPIObject::DeprecatedConfigurationResponse
    #  - Jamf::OAPIObject::LdapConfigurationResponse
    #
    # Sub Objects:
    # Other object models used by this model's attributes.
    #  - Jamf::OAPIObject::UserMappings
    #  - Jamf::OAPIObject::GroupMappings
    #  - Jamf::OAPIObject::MembershipMappings
    #
    ...
    #
    #
    class CloudLdapMappingsResponse < OAPIObject
