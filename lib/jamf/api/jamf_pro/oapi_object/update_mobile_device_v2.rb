...
module Jamf
  ...
  class OAPIObject
    ...
    #  - Jamf::OAPIObject::UpdateIosV2
    #  - Jamf::OAPIObject::UpdateTvOs
    #
    ...
    #
    #
    class UpdateMobileDeviceV2 < OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute ios
        #   @return [Jamf::OAPIObject::UpdateIosV2]
        ios: {
          class: Jamf::OAPIObject::UpdateIosV2
        },

        # @!attribute tvos
        #   @return [Jamf::OAPIObject::UpdateTvOs]
        tvos: {
          class: Jamf::OAPIObject::UpdateTvOs
        }
