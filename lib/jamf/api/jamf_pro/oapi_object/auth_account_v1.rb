...
module Jamf
  ...
  class OAPIObject
    ...
    # of their attributes.
    #  - Jamf::OAPIObject::AuthorizationV1
    #
    # Sub Objects:
    # Other object models used by this model's attributes.
    #  - Jamf::OAPIObject::AccountPreferencesV1
    #
    ...
    #
    #
    class AuthAccountV1 < OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        #   @return [Jamf::OAPIObject::AccountPreferencesV1]
        preferences: {
          class: Jamf::OAPIObject::AccountPreferencesV1
        },
