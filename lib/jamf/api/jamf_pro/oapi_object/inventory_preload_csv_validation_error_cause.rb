...
module Jamf
  ...
  class OAPIObject
    ...
    # of their attributes.
    #  - Jamf::OAPIObject::InventoryPreloadCsvValidationError
    #
    # Sub Objects:
    ...
    #
    #
    class InventoryPreloadCsvValidationErrorCause < OAPIObject
      ...
      }.merge(Jamf::OAPIObject::ApiErrorCause::OAPI_PROPERTIES) # end OAPI_PROPERTIES
