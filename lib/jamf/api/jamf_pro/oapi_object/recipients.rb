...
module Jamf
  ...
  class OAPIObject
    ...
    # of their attributes.
    #  - Jamf::OAPIObject::VppTokenSubscription
    #
    # Sub Objects:
    # Other object models used by this model's attributes.
    #  - Jamf::OAPIObject::Recipient
    #
    ...
    class Recipients < OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        #   @return [Array<Jamf::OAPIObject::Recipient>]
        recipientList: {
          class: Jamf::OAPIObject::Recipient,
          multi: true
        }
