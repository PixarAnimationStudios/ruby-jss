...
module Jamf
  ...
  class OAPIObject
    ...
    # of their attributes.
    #  - Jamf::OAPIObject::EnrollmentCustomizationSearchResultsV2
    #
    # Sub Objects:
    # Other object models used by this model's attributes.
    #  - Jamf::OAPIObject::EnrollmentCustomizationBrandingSettings
    #
    ...
    #
    #
    class EnrollmentCustomizationV2 < OAPIObject
