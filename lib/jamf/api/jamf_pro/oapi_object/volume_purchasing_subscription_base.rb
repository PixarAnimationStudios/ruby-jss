...
module Jamf
  ...
  class OAPIObject
    ...
    #  - Jamf::OAPIObject::InternalRecipient
    #  - Jamf::OAPIObject::ExternalRecipient
    #
    ...
    class VolumePurchasingSubscriptionBase < OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        #   @return [Array<Jamf::OAPIObject::InternalRecipient>]
        internalRecipients: {
          class: Jamf::OAPIObject::InternalRecipient,
          multi: true
        },

        # @!attribute externalRecipients
        #   @return [Array<Jamf::OAPIObject::ExternalRecipient>]
        externalRecipients: {
          class: Jamf::OAPIObject::ExternalRecipient,
          multi: true
        },
