...
module Jamf
  ...
  class OAPIObject
    ...
    # OAPI Object Model and Enums for: DeprecatedConfigurationResponse
    #
    ...
    # of their attributes.
    #  - Jamf::OAPIObject::DeprecatedConfigurationSearchResults
    #
    # Sub Objects:
    # Other object models used by this model's attributes.
    #  - Jamf::OAPIObject::DeprecatedServerResponse
    #  - Jamf::OAPIObject::CloudLdapMappingsResponse
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/v1/cloud-ldaps:POST' needs permissions:
    #    - Create LDAP Servers
    #  - '/v1/cloud-ldaps/{id}:GET' needs permissions:
    #    - Read LDAP Servers
    #  - '/v1/cloud-ldaps/{id}:PUT' needs permissions:
    #    - Update LDAP Servers
    #
    #
    class DeprecatedConfigurationResponse < OAPIObject
    ...
    end # class DeprecatedConfigurationResponse
