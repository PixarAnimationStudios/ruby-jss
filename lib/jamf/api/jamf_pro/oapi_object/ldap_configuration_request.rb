...
module Jamf
  ...
  class OAPIObject
    ...
    #  - Jamf::OAPIObject::CloudIdPCommonRequest
    #  - Jamf::OAPIObject::CloudLdapServerRequest
    ...
    #
    #
    class LdapConfigurationRequest < OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        #   @return [Jamf::OAPIObject::CloudIdPCommonRequest]
        cloudIdPCommon: {
          class: Jamf::OAPIObject::CloudIdPCommonRequest,
          required: true
        },

        # @!attribute server
        #   @return [Jamf::OAPIObject::CloudLdapServerRequest]
        server: {
          class: Jamf::OAPIObject::CloudLdapServerRequest,
          required: true
        },
