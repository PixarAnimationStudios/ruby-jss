...
module Jamf
  ...
  class OAPIObject
    ...
    #
    #
    class DeprecatedConfigurationSearchResults < OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::OAPIObject::DeprecatedConfigurationResponse>]
        results: {
          class: Jamf::OAPIObject::DeprecatedConfigurationResponse,
          multi: true
        }
