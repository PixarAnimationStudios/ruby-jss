...
module Jamf
  ...
  class OAPIObject
    ...
    #  - Jamf::OAPIObject::EnrollmentAccessGroup
    #
    ...
    #
    #
    class AccessGroupsSearchResults < OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::OAPIObject::EnrollmentAccessGroup>]
        results: {
          class: Jamf::OAPIObject::EnrollmentAccessGroup,
          multi: true
        }
