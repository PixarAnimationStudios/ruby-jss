...
module Jamf
  ...
  class OAPIObject
    ...
    #  - Jamf::OAPIObject::ComputerContentCachingParent
    #  - Jamf::OAPIObject::ComputerContentCachingAlert
    #  - Jamf::OAPIObject::ComputerContentCachingCacheDetail
    #  - Jamf::OAPIObject::ComputerContentCachingDataMigrationError
    #
    ...
    #
    #
    class ComputerContentCaching < OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute [r] parents
        #   @return [Array<Jamf::OAPIObject::ComputerContentCachingParent>]
        parents: {
          class: Jamf::OAPIObject::ComputerContentCachingParent,
          readonly: true,
          multi: true
        },

        # @!attribute [r] alerts
        #   @return [Array<Jamf::OAPIObject::ComputerContentCachingAlert>]
        alerts: {
          class: Jamf::OAPIObject::ComputerContentCachingAlert,
          readonly: true,
          multi: true
        },
        ...
        #   @return [Array<Jamf::OAPIObject::ComputerContentCachingCacheDetail>]
        cacheDetails: {
          class: Jamf::OAPIObject::ComputerContentCachingCacheDetail,
          readonly: true,
          multi: true
        },
