...
module Jamf
  ...
  class OAPIObject
    ...
    #  - Jamf::OAPIObject::CloudLdapServerResponse
    ...
    #
    #
    class LdapConfigurationResponse < OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute server
        #   @return [Jamf::OAPIObject::CloudLdapServerResponse]
        server: {
          class: Jamf::OAPIObject::CloudLdapServerResponse,
          required: true
        },
