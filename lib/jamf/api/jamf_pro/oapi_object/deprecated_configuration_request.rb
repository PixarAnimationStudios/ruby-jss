...
module Jamf
  ...
  class OAPIObject
    ...
    #  - Jamf::OAPIObject::DeprecatedServerRequest
    ...
    #
    #
    class DeprecatedConfigurationRequest < OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute server
        #   @return [Jamf::OAPIObject::DeprecatedServerRequest]
        server: {
          class: Jamf::OAPIObject::DeprecatedServerRequest,
          required: true
        },
