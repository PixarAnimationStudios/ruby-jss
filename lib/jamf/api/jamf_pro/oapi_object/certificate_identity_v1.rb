...
module Jamf
  ...
  class OAPIObject
    ...
    # OAPI Object Model and Enums for: CertificateIdentityV1
    #
    #
    #
    ...
    # of their attributes.
    #  - Jamf::OAPIObject::EnrollmentSettings
    #
    # Sub Objects:
    ...
    #
    #
    class CertificateIdentityV1 < OAPIObject
    ...
    end # class CertificateIdentityV1
