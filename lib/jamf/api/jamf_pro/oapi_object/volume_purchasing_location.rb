  ...
  class OAPIObject
    ...
    class VolumePurchasingLocation < OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute [r] content
        #   @return [Array<Jamf::OAPIObject::VolumePurchasingContent>]
        content: {
          class: Jamf::OAPIObject::VolumePurchasingContent,
          readonly: true,
          multi: true
        }

      }.merge(Jamf::OAPIObject::VolumePurchasingLocationListView::OAPI_PROPERTIES) # end OAPI_PROPERTIES
