...
module Jamf
  ...
  class OAPIObject
    ...
    # of their attributes.
    #  - Jamf::OAPIObject::InventoryPreloadRecordSearchResults
    #
    # Sub Objects:
    # Other object models used by this model's attributes.
    #  - Jamf::OAPIObject::InventoryPreloadExtensionAttribute
    #
    ...
    #
    #
    class InventoryPreloadRecord < OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        #   @return [Array<Jamf::OAPIObject::InventoryPreloadExtensionAttribute>]
        extensionAttributes: {
          class: Jamf::OAPIObject::InventoryPreloadExtensionAttribute,
          multi: true
        }
