...
module Jamf
  ...
  class OAPIObject
    ...
    #  - Jamf::OAPIObject::OrderBy
    #  - Jamf::OAPIObject::Filter
    #
    ...
    #
    #
    class SearchActivePatchHistoryParams < OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute orderBy
        #   @return [Array<Jamf::OAPIObject::OrderBy>]
        orderBy: {
          class: Jamf::OAPIObject::OrderBy,
          multi: true
        },

        # @!attribute filter
        #   @return [Array<Jamf::OAPIObject::Filter>]
        filter: {
          class: Jamf::OAPIObject::Filter,
          multi: true
        }
