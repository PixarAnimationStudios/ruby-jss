...
module Jamf
  ...
  class OAPIObject
    ...
    #  - Jamf::OAPIObject::MobileDevicePrestageName
    #
    ...
    #
    #
    class MobileDevicePrestageNames < OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        #   @return [Array<Jamf::OAPIObject::MobileDevicePrestageName>]
        prestageDeviceNames: {
          class: Jamf::OAPIObject::MobileDevicePrestageName,
          multi: true
        },
