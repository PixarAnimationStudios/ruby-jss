...
module Jamf
  ...
  class OAPIObject
    ...
    # of their attributes.
    #  - Jamf::OAPIObject::VolumePurchasingSubscriptions
    #
    # Sub Objects:
    ...
    #
    #
    class VolumePurchasingSubscription < OAPIObject
      ...
      }.merge(Jamf::OAPIObject::VolumePurchasingSubscriptionBase::OAPI_PROPERTIES) # end OAPI_PROPERTIES
