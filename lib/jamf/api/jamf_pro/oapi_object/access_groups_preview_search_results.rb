...
module Jamf
  ...
  class OAPIObject
    ...
    #  - Jamf::OAPIObject::EnrollmentAccessGroupPreview
    #
    ...
    class AccessGroupsPreviewSearchResults < OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::OAPIObject::EnrollmentAccessGroupPreview>]
        results: {
          class: Jamf::OAPIObject::EnrollmentAccessGroupPreview,
          multi: true
        }
