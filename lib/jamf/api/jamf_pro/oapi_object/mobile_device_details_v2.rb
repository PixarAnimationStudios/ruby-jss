...
module Jamf
  ...
  class OAPIObject
    ...
    #  - Jamf::OAPIObject::ExtensionAttributeV2
    #  - Jamf::OAPIObject::LocationV2
    #  - Jamf::OAPIObject::IosDetailsV2
    #  - Jamf::OAPIObject::TvOsDetails
    #
    ...
    #
    #
    class MobileDeviceDetailsV2 < OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        #   @return [Array<Jamf::OAPIObject::ExtensionAttributeV2>]
        extensionAttributes: {
          class: Jamf::OAPIObject::ExtensionAttributeV2,
          multi: true
        },

        # @!attribute location
        #   @return [Jamf::OAPIObject::LocationV2]
        location: {
          class: Jamf::OAPIObject::LocationV2
        },
        ...
        # @!attribute ios
        #   @return [Jamf::OAPIObject::IosDetailsV2]
        ios: {
          class: Jamf::OAPIObject::IosDetailsV2
        },

        # @!attribute tvos
        #   @return [Jamf::OAPIObject::TvOsDetails]
        tvos: {
          class: Jamf::OAPIObject::TvOsDetails
        }
