...
module Jamf
  ...
  class OAPIObject
    ...
    # of their attributes.
    #  - Jamf::OAPIObject::DeprecatedConfigurationRequest
    #  - Jamf::OAPIObject::DeprecatedConfigurationUpdate
    #  - Jamf::OAPIObject::LdapConfigurationRequest
    #  - Jamf::OAPIObject::LdapConfigurationUpdate
    #
    # Sub Objects:
    ...
    #
    #
    class CloudLdapMappingsRequest < OAPIObject
