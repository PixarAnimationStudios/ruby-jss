...
module Jamf
  ...
  class OAPIObject
    ...
    #  - Jamf::OAPIObject::PatchPolicyLog
    #
    ...
    #
    #
    class PatchPolicyLogSearchResults < OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::OAPIObject::PatchPolicyLog>]
        results: {
          class: Jamf::OAPIObject::PatchPolicyLog,
          multi: true
        },
