...
module Jamf
  ...
  class OAPIObject
    ...
    #  - Jamf::OAPIObject::AuthAccount
    #  - Jamf::OAPIObject::AccountGroup
    ...
    #
    #
    class Authorization < OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute account
        #   @return [Jamf::OAPIObject::AuthAccount]
        account: {
          class: Jamf::OAPIObject::AuthAccount
        },

        # @!attribute accountGroups
        #   @return [Array<Jamf::OAPIObject::AccountGroup>]
        accountGroups: {
          class: Jamf::OAPIObject::AccountGroup,
          multi: true
        },
