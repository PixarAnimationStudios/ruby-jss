...
module Jamf
  ...
  module OAPISchemas
    ...
    #
    #
    class EnrollmentSettings < Jamf::OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        #   @return [Jamf::OAPISchemas::MdmSigningCertificate]
        mdmSigningCertificate: {
          class: Jamf::OAPISchemas::MdmSigningCertificate
        },
        ...
        #   @return [Jamf::OAPISchemas::CertificateIdentityV1]
        developerCertificateIdentity: {
          class: Jamf::OAPISchemas::CertificateIdentityV1
        },
