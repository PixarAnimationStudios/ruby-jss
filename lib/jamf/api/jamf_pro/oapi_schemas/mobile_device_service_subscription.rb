...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: MobileDeviceServiceSubscription
    #
    #
    #
    ...
    #
    #
    class MobileDeviceServiceSubscription < Jamf::OAPIObject
    ...
    end # class MobileDeviceServiceSubscription
