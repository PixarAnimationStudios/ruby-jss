...
module Jamf
  ...
  module OAPISchemas
    ...
    # of their attributes.
    #  - Jamf::OAPISchemas::DeprecatedConfigurationSearchResults
    #
    # Sub Objects:
    ...
    #
    #
    class DeprecatedConfigurationResponse < Jamf::OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute server
        #   @return [Jamf::OAPISchemas::DeprecatedServerResponse]
        server: {
