...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: DeprecatedConfigurationUpdate
    #
    ...
    #
    #
    class DeprecatedConfigurationUpdate < Jamf::OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute server
        #   @return [Jamf::OAPISchemas::DeprecatedServerUpdate]
        server: {
    ...
    end # class DeprecatedConfigurationUpdate
