...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: AdvancedUserContentSearchSearchResults
    #
    ...
    #  - OAPIObjectModels::AdvancedUserContentSearch
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/v1/advanced-user-content-searches:GET', needs permissions: Read Advanced User Content Searches
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::AdvancedUserContentSearchSearchResults
    #
    module AdvancedUserContentSearchSearchResults
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::AdvancedUserContentSearch>]
        results: {
          class: Jamf::AdvancedUserContentSearch,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module AdvancedUserContentSearchSearchResults
