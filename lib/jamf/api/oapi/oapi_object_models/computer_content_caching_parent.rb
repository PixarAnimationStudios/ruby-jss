...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ComputerContentCachingParent
    #
    ...
    #  - OAPIObjectModels::ComputerContentCachingParentAlert
    #  - OAPIObjectModels::ComputerContentCachingParentDetails
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ComputerContentCachingParent
    #
    module ComputerContentCachingParent
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute alerts
        #   @return [Jamf::ComputerContentCachingParentAlert]
        alerts: {
          class: Jamf::ComputerContentCachingParentAlert
        },

        # @!attribute details
        #   @return [Jamf::ComputerContentCachingParentDetails]
        details: {
          class: Jamf::ComputerContentCachingParentDetails
        },
    ...
    end # module ComputerContentCachingParent
