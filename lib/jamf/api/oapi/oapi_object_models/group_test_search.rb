...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: GroupTestSearch
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::GroupTestSearchResponse
    #
    # Sub Objects:
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::GroupTestSearch
    #
    module GroupTestSearch
