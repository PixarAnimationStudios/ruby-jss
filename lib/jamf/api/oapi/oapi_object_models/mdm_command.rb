...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: MdmCommand
    #
    ...
    #  - OAPIObjectModels::MdmCommandClient
    #  - OAPIObjectModels::MdmCommandState
    #  - OAPIObjectModels::MdmCommandType
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/v1/mdm/commands:GET', needs permissions: View MDM command information in Jamf Pro API
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::MdmCommand
    #
    module MdmCommand
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute client
        #   @return [Jamf::MdmCommandClient]
        client: {
          class: Jamf::MdmCommandClient
        },

        # @!attribute commandState
        #   @return [Jamf::MdmCommandState]
        commandState: {
          class: Jamf::MdmCommandState
        },

        # @!attribute commandType
        #   @return [Jamf::MdmCommandType]
        commandType: {
          class: Jamf::MdmCommandType
        }

      } # end OAPI_PROPERTIES

    end # module MdmCommand
