...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: TeacherSettingsRequest
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::TeacherSettingsRequest
    #
    module TeacherSettingsRequest
    ...
    end # module TeacherSettingsRequest
