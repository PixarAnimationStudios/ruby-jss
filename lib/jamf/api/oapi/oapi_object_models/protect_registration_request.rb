...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ProtectRegistrationRequest
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ProtectRegistrationRequest
    #
    module ProtectRegistrationRequest
    ...
    end # module ProtectRegistrationRequest
