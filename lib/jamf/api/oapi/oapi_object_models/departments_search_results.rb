...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: DepartmentsSearchResults
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::DepartmentsSearchResults
    #
    module DepartmentsSearchResults
    ...
    end # module DepartmentsSearchResults
