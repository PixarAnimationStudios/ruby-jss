...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: DeviceEnrollmentDeviceSearchResults
    #
    ...
    #  - OAPIObjectModels::DeviceEnrollmentDevice
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/v1/device-enrollments/{id}/devices:GET', needs permissions: Read Device Enrollment Program Instances
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::DeviceEnrollmentDeviceSearchResults
    #
    module DeviceEnrollmentDeviceSearchResults
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::DeviceEnrollmentDevice>]
        results: {
    ...
    end # module DeviceEnrollmentDeviceSearchResults
