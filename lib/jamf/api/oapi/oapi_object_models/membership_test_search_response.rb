...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: MembershipTestSearchResponse
    #
    ...
    #  - '/v1/cloud-idp/{id}/test-user-membership:POST', needs permissions: Read LDAP Servers
    #  - '/v1/cloud-ldaps/{id}/test-user-membership:POST', needs permissions: Read LDAP Servers
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::MembershipTestSearchResponse
    #
    module MembershipTestSearchResponse
    ...
    end # module MembershipTestSearchResponse
