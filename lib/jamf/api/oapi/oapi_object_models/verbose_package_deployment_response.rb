...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: VerbosePackageDeploymentResponse
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::VerbosePackageDeploymentResponse
    #
    module VerbosePackageDeploymentResponse
    ...
    end # module VerbosePackageDeploymentResponse
