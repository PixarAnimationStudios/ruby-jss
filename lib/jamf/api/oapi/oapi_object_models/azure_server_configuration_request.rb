...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: AzureServerConfigurationRequest
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::AzureConfigurationRequest
    #
    # Sub Objects:
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::AzureServerConfigurationRequest
    #
    module AzureServerConfigurationRequest
    ...
    end # module AzureServerConfigurationRequest
