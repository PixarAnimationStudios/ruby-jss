...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: AuthTokenV1
    #
    ...
    #  - '/v1/auth/keep-alive:POST', needs permissions: Unknown
    #  - '/v1/auth/token:POST', needs permissions: Unknown
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::AuthTokenV1
    #
    module AuthTokenV1
