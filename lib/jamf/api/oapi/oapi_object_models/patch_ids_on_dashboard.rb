...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: PatchIdsOnDashboard
    #
    ...
    #  - '/patch/onDashboard:GET', needs permissions: Read Patch Management Software Titles
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::PatchIdsOnDashboard
    #
    module PatchIdsOnDashboard
    ...
    end # module PatchIdsOnDashboard
