...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: JamfApplicationResponse
    #
    ...
    #  - OAPIObjectModels::JamfPackageResponse
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/v2/jamf-package:GET', needs permissions: Jamf Packages Action
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::JamfApplicationResponse
    #
    module JamfApplicationResponse
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute artifacts
        #   @return [Array<Jamf::JamfPackageResponse>]
        artifacts: {
          class: Jamf::JamfPackageResponse,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module JamfApplicationResponse
