...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: PrestageScopeAssignmentV2
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::PrestageScopeResponseV2
    #
    # Sub Objects:
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::PrestageScopeAssignmentV2
    #
    module PrestageScopeAssignmentV2
    ...
    end # module PrestageScopeAssignmentV2
