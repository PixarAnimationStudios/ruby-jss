...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ComputerContentCachingParentAlert
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ComputerContentCachingParentAlert
    #
    module ComputerContentCachingParentAlert
    ...
    end # module ComputerContentCachingParentAlert
