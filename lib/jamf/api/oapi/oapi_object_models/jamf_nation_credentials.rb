...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: JamfNationCredentials
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::JamfNationCredentials
    #
    module JamfNationCredentials
    ...
    end # module JamfNationCredentials
