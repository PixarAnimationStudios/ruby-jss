...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: SelfServiceInstallSettings
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::SelfServiceInstallSettings
    #
    module SelfServiceInstallSettings
    ...
    end # module SelfServiceInstallSettings
