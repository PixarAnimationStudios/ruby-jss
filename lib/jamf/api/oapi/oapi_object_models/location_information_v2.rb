...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: LocationInformationV2
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::LocationInformationV2
    #
    module LocationInformationV2
    ...
    end # module LocationInformationV2
