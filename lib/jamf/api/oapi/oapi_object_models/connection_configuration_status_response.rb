...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ConnectionConfigurationStatusResponse
    #
    ...
    #  - '/preview/remote-administration-configurations/team-viewer/{id}/status:GET', needs permissions: Read Remote Administration
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ConnectionConfigurationStatusResponse
    #
    module ConnectionConfigurationStatusResponse
    ...
    end # module ConnectionConfigurationStatusResponse
