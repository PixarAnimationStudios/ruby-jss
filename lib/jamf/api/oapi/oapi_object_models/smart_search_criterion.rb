...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: SmartSearchCriterion
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::SmartSearchCriterion
    #
    module SmartSearchCriterion
    ...
    end # module SmartSearchCriterion
