...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ConfigurationSearchResults
    #
    ...
    #  - OAPIObjectModels::CloudIdPCommonResponse
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/v1/cloud-idp:GET', needs permissions: Read LDAP Servers
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ConfigurationSearchResults
    #
    module ConfigurationSearchResults
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::CloudIdPCommonResponse>]
        results: {
          class: Jamf::CloudIdPCommonResponse,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module ConfigurationSearchResults
