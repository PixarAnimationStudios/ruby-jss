...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: JamfProtectPlan
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::PlanSearchResults
    #
    # Sub Objects:
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::JamfProtectPlan
    #
    module JamfProtectPlan
