...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: InternalRecipient
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::VolumePurchasingSubscriptionBase
    #
    # Sub Objects:
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::InternalRecipient
    #
    module InternalRecipient
