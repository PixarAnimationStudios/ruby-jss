...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ComputerInventorySearchResults
    #
    ...
    #  - '/v1/computers-inventory:GET', needs permissions: Read Computers
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ComputerInventorySearchResults
    #
    module ComputerInventorySearchResults
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::ComputerInventoryResponse>]
        results: {
          class: Jamf::ComputerInventoryResponse,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module ComputerInventorySearchResults
