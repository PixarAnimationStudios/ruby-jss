...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: PrestageScopeUpdate
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::PrestageScopeUpdate
    #
    module PrestageScopeUpdate
    ...
    end # module PrestageScopeUpdate
