...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: MobileDeviceExtensionAttributeResults
    #
    ...
    #  - '/devices/extensionAttributes:GET', needs permissions: Read Mobile Device Extension Attributes
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::MobileDeviceExtensionAttributeResults
    #
    module MobileDeviceExtensionAttributeResults
    ...
    end # module MobileDeviceExtensionAttributeResults
