...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: CloudIdPCommonRequest
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::CloudIdPCommonRequest
    #
    module CloudIdPCommonRequest
    ...
    end # module CloudIdPCommonRequest
