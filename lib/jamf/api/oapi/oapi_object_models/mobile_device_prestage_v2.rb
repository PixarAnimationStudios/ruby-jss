...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: MobileDevicePrestageV2
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::MobileDevicePrestageV2
    #
    module MobileDevicePrestageV2
    ...
    end # module MobileDevicePrestageV2
