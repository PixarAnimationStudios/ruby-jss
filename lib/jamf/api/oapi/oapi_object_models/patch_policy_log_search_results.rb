...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: PatchPolicyLogSearchResults
    #
    ...
    #  - OAPIObjectModels::PatchPolicyLog
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::PatchPolicyLogSearchResults
    #
    module PatchPolicyLogSearchResults
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::PatchPolicyLog>]
        results: {
          class: Jamf::PatchPolicyLog,
          multi: true
        },
    ...
    end # module PatchPolicyLogSearchResults
