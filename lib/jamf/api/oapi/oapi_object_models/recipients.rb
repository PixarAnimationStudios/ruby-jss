...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: Recipients
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::VppTokenSubscription
    #
    # Sub Objects:
    # Other object models used by this model's attributes.
    #  - OAPIObjectModels::Recipient
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::Recipients
    #
    module Recipients
      ...
      OAPI_PROPERTIES = {
        ...
        #   @return [Array<Jamf::Recipient>]
        recipientList: {
          class: Jamf::Recipient,
          multi: true
        }
