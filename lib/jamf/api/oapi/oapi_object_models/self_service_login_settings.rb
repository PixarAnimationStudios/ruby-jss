...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: SelfServiceLoginSettings
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::SelfServiceLoginSettings
    #
    module SelfServiceLoginSettings
    ...
    end # module SelfServiceLoginSettings
