...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: SoftwareTitlePatchPolicySummaries
    #
    ...
    #  - OAPIObjectModels::PatchPolicySummary
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::SoftwareTitlePatchPolicySummaries
    #
    module SoftwareTitlePatchPolicySummaries
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::PatchPolicySummary>]
        results: {
          class: Jamf::PatchPolicySummary,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module SoftwareTitlePatchPolicySummaries
