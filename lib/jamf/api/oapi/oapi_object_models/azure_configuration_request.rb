...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: AzureConfigurationRequest
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::AzureConfigurationRequest
    #
    module AzureConfigurationRequest
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute server
        #   @return [Jamf::AzureServerConfigurationRequest]
        server: {
          class: Jamf::AzureServerConfigurationRequest,
          required: true
        }

      } # end OAPI_PROPERTIES

    end # module AzureConfigurationRequest
