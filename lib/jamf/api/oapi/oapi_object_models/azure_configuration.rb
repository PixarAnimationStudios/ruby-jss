...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: AzureConfiguration
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::AzureConfiguration
    #
    module AzureConfiguration
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute server
        #   @return [Jamf::AzureServerConfiguration]
        server: {
          class: Jamf::AzureServerConfiguration,
          required: true
        }

      } # end OAPI_PROPERTIES

    end # module AzureConfiguration
