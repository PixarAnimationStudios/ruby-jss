...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ComputerStorage
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ComputerStorage
    #
    module ComputerStorage
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute disks
        #   @return [Array<Jamf::ComputerDisk>]
        disks: {
          class: Jamf::ComputerDisk,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module ComputerStorage
