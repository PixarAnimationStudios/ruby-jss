...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: PolicyProperties
    #
    ...
    #  - '/settings/obj/policyProperties:GET', needs permissions: Read Policies
    #  - '/settings/obj/policyProperties:PUT', needs permissions: Update Policies
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::PolicyProperties
    #
    module PolicyProperties
