...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: PostComputerPrestageV2
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::PostComputerPrestageV2
    #
    module PostComputerPrestageV2
    ...
    end # module PostComputerPrestageV2
