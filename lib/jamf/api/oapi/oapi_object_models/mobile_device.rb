...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: MobileDevice
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::MobileDeviceSearchResults
    #
    # Sub Objects:
    ...
    #  - '/v1/mobile-devices:GET', needs permissions: Read Mobile Devices
    #  - '/v1/mobile-devices/{id}:GET', needs permissions: Read Mobile Devices
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::MobileDevice
    #
    module MobileDevice
