...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: VolumePurchasingLocationListView
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::VolumePurchasingLocations
    #
    # Sub Objects:
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::VolumePurchasingLocationListView
    #
    module VolumePurchasingLocationListView
    ...
    end # module VolumePurchasingLocationListView
