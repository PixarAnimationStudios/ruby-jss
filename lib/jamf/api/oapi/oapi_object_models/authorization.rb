...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: Authorization
    #
    ...
    module Authorization
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute account
        #   @return [Jamf::AuthAccount]
        account: {
          class: Jamf::AuthAccount
        },
