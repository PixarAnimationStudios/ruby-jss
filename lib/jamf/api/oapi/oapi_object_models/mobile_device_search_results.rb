...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: MobileDeviceSearchResults
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::MobileDeviceSearchResults
    #
    module MobileDeviceSearchResults
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::MobileDevice>]
        results: {
    ...
    end # module MobileDeviceSearchResults
