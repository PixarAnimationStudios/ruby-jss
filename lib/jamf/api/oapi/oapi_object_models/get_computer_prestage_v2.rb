...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: GetComputerPrestageV2
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::ComputerPrestageSearchResultsV2
    #
    # Sub Objects:
    ...
    #  - '/v2/computer-prestages/{id}:GET', needs permissions: Read Computer PreStage Enrollments
    #  - '/v2/computer-prestages/{id}:PUT', needs permissions: Update Computer PreStage Enrollments
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::GetComputerPrestageV2
    #
    module GetComputerPrestageV2
    ...
    end # module GetComputerPrestageV2
