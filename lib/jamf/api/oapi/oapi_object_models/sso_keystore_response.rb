...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: SsoKeystoreResponse
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::SsoKeystoreResponseWithDetails
    #
    # Sub Objects:
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::SsoKeystoreResponse
    #
    module SsoKeystoreResponse
    ...
    end # module SsoKeystoreResponse
