...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: MobileDeviceCertificateV2
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::MobileDeviceCertificateV2
    #
    module MobileDeviceCertificateV2
    ...
    end # module MobileDeviceCertificateV2
