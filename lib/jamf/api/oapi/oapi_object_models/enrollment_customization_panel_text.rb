...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: EnrollmentCustomizationPanelText
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::EnrollmentCustomizationPanelText
    #
    module EnrollmentCustomizationPanelText
    ...
    end # module EnrollmentCustomizationPanelText
