...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: Ebook
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::EbookSearchResults
    #
    # Sub Objects:
