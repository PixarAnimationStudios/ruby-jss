...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: MacOsManagedSoftwareUpdateResponse
    #
    ...
    #  - OAPIObjectModels::HrefResponse
    #  - OAPIObjectModels::ApiErrorCause
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::MacOsManagedSoftwareUpdateResponse
    #
    module MacOsManagedSoftwareUpdateResponse
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute responses
        #   @return [Array<Jamf::HrefResponse>]
        responses: {
          class: Jamf::HrefResponse,
          multi: true
        },

        # @!attribute errors
        #   @return [Array<Jamf::ApiErrorCause>]
        errors: {
          class: Jamf::ApiErrorCause,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module MacOsManagedSoftwareUpdateResponse
