...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: AccessGroupsPreviewSearchResults
    #
    ...
    #  - OAPIObjectModels::EnrollmentAccessGroupPreview
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::AccessGroupsPreviewSearchResults
    #
    module AccessGroupsPreviewSearchResults
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::EnrollmentAccessGroupPreview>]
        results: {
          class: Jamf::EnrollmentAccessGroupPreview,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module AccessGroupsPreviewSearchResults
