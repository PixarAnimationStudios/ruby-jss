...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: HistorySearchResultsV1
    #
    ...
    #  - OAPIObjectModels::ObjectHistoryV1
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/v2/check-in/history:GET', needs permissions: Read Computer Check-In
    #  - '/v3/check-in/history:GET', needs permissions: Read Computer Check-In
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::HistorySearchResultsV1
    #
    module HistorySearchResultsV1
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::ObjectHistoryV1>]
        results: {
          class: Jamf::ObjectHistoryV1,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module HistorySearchResultsV1
