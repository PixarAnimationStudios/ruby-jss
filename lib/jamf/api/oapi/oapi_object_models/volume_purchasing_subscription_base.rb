...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: VolumePurchasingSubscriptionBase
    #
    ...
    #  - OAPIObjectModels::InternalRecipient
    #  - OAPIObjectModels::ExternalRecipient
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::VolumePurchasingSubscriptionBase
    #
    module VolumePurchasingSubscriptionBase
      ...
      OAPI_PROPERTIES = {
        ...
        #   @return [Array<Jamf::InternalRecipient>]
        internalRecipients: {
          class: Jamf::InternalRecipient,
          multi: true
        },

        # @!attribute externalRecipients
        #   @return [Array<Jamf::ExternalRecipient>]
        externalRecipients: {
          class: Jamf::ExternalRecipient,
          multi: true
        },
    ...
    end # module VolumePurchasingSubscriptionBase
