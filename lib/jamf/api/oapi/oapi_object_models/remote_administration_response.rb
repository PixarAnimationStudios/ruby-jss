...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: RemoteAdministrationResponse
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::RemoteAdministrationSearchResults
    #
    # Sub Objects:
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::RemoteAdministrationResponse
    #
    module RemoteAdministrationResponse
    ...
    end # module RemoteAdministrationResponse
