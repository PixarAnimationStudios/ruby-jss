...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: SupervisionIdentityCertificateUpload
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::SupervisionIdentityCertificateUpload
    #
    module SupervisionIdentityCertificateUpload
    ...
    end # module SupervisionIdentityCertificateUpload
