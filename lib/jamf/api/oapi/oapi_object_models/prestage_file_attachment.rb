...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: PrestageFileAttachment
    #
    ...
    #  - '/v1/mobile-device-prestages/{id}/attachments:POST', needs permissions: Create Mobile Device PreStage Enrollments
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::PrestageFileAttachment
    #
    module PrestageFileAttachment
    ...
    end # module PrestageFileAttachment
