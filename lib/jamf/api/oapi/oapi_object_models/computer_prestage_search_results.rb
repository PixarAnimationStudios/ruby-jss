...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ComputerPrestageSearchResults
    #
    ...
    #  - OAPIObjectModels::GetComputerPrestage
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/v1/computer-prestages:GET', needs permissions: Read Computer PreStage Enrollments
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ComputerPrestageSearchResults
    #
    module ComputerPrestageSearchResults
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::GetComputerPrestage>]
        results: {
          class: Jamf::GetComputerPrestage,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module ComputerPrestageSearchResults
