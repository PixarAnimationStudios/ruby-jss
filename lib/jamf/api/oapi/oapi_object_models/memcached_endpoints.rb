...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: MemcachedEndpoints
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::CacheSettings
    #
    # Sub Objects:
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::MemcachedEndpoints
    #
    module MemcachedEndpoints
