...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: GetEnrollmentCustomizationPanelLdapAuth
    #
    ...
    #  - '/v1/enrollment-customization/{id}/ldap/{panel-id}:GET', needs permissions: Read Enrollment Customizations
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::GetEnrollmentCustomizationPanelLdapAuth
    #
    module GetEnrollmentCustomizationPanelLdapAuth
    ...
    end # module GetEnrollmentCustomizationPanelLdapAuth
