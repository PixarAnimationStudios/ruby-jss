...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ComputerInventoryRecoveryLockPasswordResponse
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ComputerInventoryRecoveryLockPasswordResponse
    #
    module ComputerInventoryRecoveryLockPasswordResponse
    ...
    end # module ComputerInventoryRecoveryLockPasswordResponse
