...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: SsoKeystoreDetails
    #
    ...
    #  - OAPIObjectModels::SsoKeystoreWithDetails
    #
    # Sub Objects:
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::SsoKeystoreDetails
    #
    module SsoKeystoreDetails
