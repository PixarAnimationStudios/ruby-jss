...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ProtectUpdatableSettingsRequest
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ProtectUpdatableSettingsRequest
    #
    module ProtectUpdatableSettingsRequest
    ...
    end # module ProtectUpdatableSettingsRequest
