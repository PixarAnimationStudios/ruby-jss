...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: EnrollmentCustomizationV2
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::EnrollmentCustomizationSearchResultsV2
    #
    # Sub Objects:
    # Other object models used by this model's attributes.
    #  - OAPIObjectModels::EnrollmentCustomizationBrandingSettings
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/v2/enrollment-customizations:POST', needs permissions: Create Enrollment Customizations
    #  - '/v2/enrollment-customizations/{id}:GET', needs permissions: Read Enrollment Customizations
    #  - '/v2/enrollment-customizations/{id}:PUT', needs permissions: Update Enrollment Customizations
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::EnrollmentCustomizationV2
    #
    module EnrollmentCustomizationV2
      ...
      OAPI_PROPERTIES = {
        ...
        #   @return [Jamf::EnrollmentCustomizationBrandingSettings]
        enrollmentCustomizationBrandingSettings: {
          class: Jamf::EnrollmentCustomizationBrandingSettings,
          required: true
        }

      } # end OAPI_PROPERTIES

    end # module EnrollmentCustomizationV2
