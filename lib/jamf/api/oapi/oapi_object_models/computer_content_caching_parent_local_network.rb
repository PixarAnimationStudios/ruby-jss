...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ComputerContentCachingParentLocalNetwork
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ComputerContentCachingParentLocalNetwork
    #
    module ComputerContentCachingParentLocalNetwork
    ...
    end # module ComputerContentCachingParentLocalNetwork
