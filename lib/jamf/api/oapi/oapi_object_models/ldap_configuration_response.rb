...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: LdapConfigurationResponse
    #
    ...
    #  - OAPIObjectModels::CloudLdapServerResponse
    #  - OAPIObjectModels::CloudLdapMappingsResponse
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/v2/cloud-ldaps/{id}:GET', needs permissions: Read LDAP Servers
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::LdapConfigurationResponse
    #
    module LdapConfigurationResponse
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute server
        #   @return [Jamf::CloudLdapServerResponse]
        server: {
          class: Jamf::CloudLdapServerResponse,
          required: true
        },
    ...
    end # module LdapConfigurationResponse
