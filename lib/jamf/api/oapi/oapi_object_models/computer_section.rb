...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ComputerSection
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ComputerSection
    #
    module ComputerSection

      # These enums are used in the properties below

      COMPUTER_SECTION_OPTIONS = [
        'GENERAL',
        'DISK_ENCRYPTION',
        'PURCHASING',
        'APPLICATIONS',
