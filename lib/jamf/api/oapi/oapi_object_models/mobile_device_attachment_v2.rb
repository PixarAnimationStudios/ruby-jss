...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: MobileDeviceAttachmentV2
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::MobileDeviceAttachmentV2
    #
    module MobileDeviceAttachmentV2
    ...
    end # module MobileDeviceAttachmentV2
