...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ComputerContentCachingAlert
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ComputerContentCachingAlert
    #
    module ComputerContentCachingAlert
    ...
    end # module ComputerContentCachingAlert
