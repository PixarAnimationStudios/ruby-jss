...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: MobileDevicePrestageNameV2
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::MobileDevicePrestageNamesV2
    #
    # Sub Objects:
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::MobileDevicePrestageNameV2
    #
    module MobileDevicePrestageNameV2
    ...
    end # module MobileDevicePrestageNameV2
