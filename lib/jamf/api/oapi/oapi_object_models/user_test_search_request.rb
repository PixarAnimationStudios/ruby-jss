...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: UserTestSearchRequest
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::UserTestSearchRequest
    #
    module UserTestSearchRequest
    ...
    end # module UserTestSearchRequest
