...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: InventoryPreloadCsvValidationError
    #
    ...
    #  - OAPIObjectModels::InventoryPreloadCsvValidationErrorCause
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::InventoryPreloadCsvValidationError
    #
    module InventoryPreloadCsvValidationError
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute errors
        #   @return [Array<Jamf::InventoryPreloadCsvValidationErrorCause>]
        errors: {
          class: Jamf::InventoryPreloadCsvValidationErrorCause,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module InventoryPreloadCsvValidationError
