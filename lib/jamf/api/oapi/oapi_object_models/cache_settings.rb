...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: CacheSettings
    #
    ...
    #  - OAPIObjectModels::MemcachedEndpoints
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::CacheSettings
    #
    module CacheSettings
      ...
      OAPI_PROPERTIES = {
        ...
        #   @return [Array<Jamf::MemcachedEndpoints>]
        memcachedEndpoints: {
          class: Jamf::MemcachedEndpoints,
          required: true,
          multi: true
        }
