...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: RemoteAdministrationSearchResults
    #
    ...
    #  - OAPIObjectModels::RemoteAdministrationResponse
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/preview/remote-administration-configurations:GET', needs permissions: Read Remote Administration
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::RemoteAdministrationSearchResults
    #
    module RemoteAdministrationSearchResults
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::RemoteAdministrationResponse>]
        results: {
          class: Jamf::RemoteAdministrationResponse,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module RemoteAdministrationSearchResults
