...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ActivePatchSummary
    #
    ...
    #  - '/patch/obj/{id}:GET', needs permissions: Read Patch Management Software Titles
    #  - '/patch/obj/{id}:PUT', needs permissions: Read Patch Management Software Titles
    #  - '/patch/{id}:GET', needs permissions: Read Patch Management Software Titles
    #  - '/patch/{id}:PUT', needs permissions: Read Patch Management Software Titles
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ActivePatchSummary
    #
    module ActivePatchSummary
