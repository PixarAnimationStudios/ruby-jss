...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: RetryPatchPolicyParams
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::RetryPatchPolicyParams
    #
    module RetryPatchPolicyParams
    ...
    end # module RetryPatchPolicyParams
