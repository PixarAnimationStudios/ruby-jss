...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: MacOsBrandingSearchResults
    #
    ...
    #  - OAPIObjectModels::MacOsBrandingConfiguration
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/v1/self-service/branding/macos:GET', needs permissions: Read Self Service Branding Configuration
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::MacOsBrandingSearchResults
    #
    module MacOsBrandingSearchResults
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::MacOsBrandingConfiguration>]
        results: {
          class: Jamf::MacOsBrandingConfiguration,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module MacOsBrandingSearchResults
