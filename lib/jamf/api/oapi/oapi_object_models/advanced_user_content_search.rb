...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: AdvancedUserContentSearch
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::AdvancedUserContentSearchSearchResults
    #
    # Sub Objects:
    # Other object models used by this model's attributes.
    #  - OAPIObjectModels::SmartSearchCriterion
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::AdvancedUserContentSearch
    #
    module AdvancedUserContentSearch
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute criteria
        #   @return [Array<Jamf::SmartSearchCriterion>]
        criteria: {
          class: Jamf::SmartSearchCriterion,
          multi: true
        },
    ...
    end # module AdvancedUserContentSearch
