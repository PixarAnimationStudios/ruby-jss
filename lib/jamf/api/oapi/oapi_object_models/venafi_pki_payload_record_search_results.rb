...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: VenafiPkiPayloadRecordSearchResults
    #
    ...
    #  - OAPIObjectModels::VenafiPkiPayloadRecord
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/v1/pki/venafi/{id}/dependent-profiles:GET', needs permissions: Read PKI
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::VenafiPkiPayloadRecordSearchResults
    #
    module VenafiPkiPayloadRecordSearchResults
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::VenafiPkiPayloadRecord>]
        results: {
          class: Jamf::VenafiPkiPayloadRecord,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module VenafiPkiPayloadRecordSearchResults
