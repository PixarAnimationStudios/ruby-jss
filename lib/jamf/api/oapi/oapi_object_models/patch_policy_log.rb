...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: PatchPolicyLog
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::PatchPolicyLogSearchResults
    #
    # Sub Objects:
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::PatchPolicyLog
    #
    module PatchPolicyLog
