...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: IconResponse
    #
    ...
    #  - '/v1/icon:POST', needs permissions: Unknown
    #  - '/v1/icon/{id}:GET', needs permissions: Unknown
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::IconResponse
    #
    module IconResponse
