...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: VolumePurchasingLocationPatch
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::VolumePurchasingLocationPatch
    #
    module VolumePurchasingLocationPatch
    ...
    end # module VolumePurchasingLocationPatch
