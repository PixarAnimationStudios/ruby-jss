...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: EnrollmentCustomizationDependency
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::EnrollmentCustomizationDependencies
    #
    # Sub Objects:
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::EnrollmentCustomizationDependency
    #
    module EnrollmentCustomizationDependency
    ...
    end # module EnrollmentCustomizationDependency
