...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: MembershipMappings
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::MembershipMappings
    #
    module MembershipMappings
