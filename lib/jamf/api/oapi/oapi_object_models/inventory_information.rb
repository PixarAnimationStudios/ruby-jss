...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: InventoryInformation
    #
    ...
    #  - '/v1/inventory-information:GET', needs permissions: Unknown
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::InventoryInformation
    #
    module InventoryInformation
    ...
    end # module InventoryInformation
