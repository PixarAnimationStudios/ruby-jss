...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: MdmCommandClient
    #
    ...
    #  - OAPIObjectModels::MdmCommandRequest
    #
    # Sub Objects:
    # Other object models used by this model's attributes.
    #  - OAPIObjectModels::MdmClientType
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::MdmCommandClient
    #
    module MdmCommandClient
      ...
      OAPI_PROPERTIES = {
        ...
        #   @return [Jamf::MdmClientType]
        clientType: {
          class: Jamf::MdmClientType
        }

      } # end OAPI_PROPERTIES

    end # module MdmCommandClient
