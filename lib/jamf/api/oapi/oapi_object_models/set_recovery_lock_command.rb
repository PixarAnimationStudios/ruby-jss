...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: SetRecoveryLockCommand
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::SetRecoveryLockCommand
    #
    module SetRecoveryLockCommand
    ...
    end # module SetRecoveryLockCommand
