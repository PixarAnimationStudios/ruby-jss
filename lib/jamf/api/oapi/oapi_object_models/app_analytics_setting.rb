...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: AppAnalyticsSetting
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::AppAnalyticsSetting
    #
    module AppAnalyticsSetting

      # These enums are used in the properties below

      APP_ANALYTICS_SETTING_OPTIONS = [
    ...
    end # module AppAnalyticsSetting
