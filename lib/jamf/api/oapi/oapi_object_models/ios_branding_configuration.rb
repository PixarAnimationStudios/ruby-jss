...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: IosBrandingConfiguration
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::IosBrandingSearchResults
    #
    # Sub Objects:
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::IosBrandingConfiguration
    #
    module IosBrandingConfiguration
    ...
    end # module IosBrandingConfiguration
