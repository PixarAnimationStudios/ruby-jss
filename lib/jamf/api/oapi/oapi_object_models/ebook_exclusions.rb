...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: EbookExclusions
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::EbookExclusions
    #
    module EbookExclusions
