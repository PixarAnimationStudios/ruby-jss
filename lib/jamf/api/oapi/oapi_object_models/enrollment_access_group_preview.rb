...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: EnrollmentAccessGroupPreview
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::AccessGroupsPreviewSearchResults
    #
    # Sub Objects:
    ...
    #  - '/preview/enrollment/access-groups/{id}:GET', needs permissions: Read User-Initiated Enrollment
    #  - '/preview/enrollment/access-groups/{id}:PUT', needs permissions: Update User-Initiated Enrollment
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::EnrollmentAccessGroupPreview
    #
    module EnrollmentAccessGroupPreview
    ...
    end # module EnrollmentAccessGroupPreview
