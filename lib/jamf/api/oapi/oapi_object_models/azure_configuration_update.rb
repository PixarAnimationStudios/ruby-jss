...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: AzureConfigurationUpdate
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::AzureConfigurationUpdate
    #
    module AzureConfigurationUpdate
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute server
        #   @return [Jamf::AzureServerConfigurationUpdate]
        server: {
          class: Jamf::AzureServerConfigurationUpdate,
          required: true
        }

      } # end OAPI_PROPERTIES

    end # module AzureConfigurationUpdate
