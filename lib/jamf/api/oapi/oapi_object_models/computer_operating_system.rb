...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ComputerOperatingSystem
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ComputerOperatingSystem
    #
    module ComputerOperatingSystem
    ...
    end # module ComputerOperatingSystem
