...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: EnrollmentCustomizationSearchResultsV2
    #
    ...
    #  - OAPIObjectModels::EnrollmentCustomizationV2
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/v2/enrollment-customizations:GET', needs permissions: Read Enrollment Customizations
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::EnrollmentCustomizationSearchResultsV2
    #
    module EnrollmentCustomizationSearchResultsV2
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::EnrollmentCustomizationV2>]
        results: {
          class: Jamf::EnrollmentCustomizationV2,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module EnrollmentCustomizationSearchResultsV2
