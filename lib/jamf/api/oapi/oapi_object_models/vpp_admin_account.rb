...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: VppAdminAccount
    #
    ...
    #  - '/vpp/admin-accounts:GET', needs permissions: Read Volume Purchasing Administrator Accounts
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::VppAdminAccount
    #
    module VppAdminAccount
