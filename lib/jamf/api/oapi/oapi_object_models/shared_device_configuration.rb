...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: SharedDeviceConfiguration
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::SharedDeviceConfiguration
    #
    module SharedDeviceConfiguration
    ...
    end # module SharedDeviceConfiguration
