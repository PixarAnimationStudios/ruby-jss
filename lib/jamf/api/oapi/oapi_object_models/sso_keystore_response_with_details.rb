...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: SsoKeystoreResponseWithDetails
    #
    ...
    #  - OAPIObjectModels::SsoKeystoreResponse
    #  - OAPIObjectModels::SsoKeystoreDetails
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/v2/sso/cert:GET', needs permissions: Read SSO Settings
    #  - '/v2/sso/cert:PUT', needs permissions: Update SSO Settings
    #  - '/v2/sso/cert:POST', needs permissions: Update SSO Settings
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::SsoKeystoreResponseWithDetails
    #
    module SsoKeystoreResponseWithDetails
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute keystore
        #   @return [Jamf::SsoKeystoreResponse]
        keystore: {
          class: Jamf::SsoKeystoreResponse
        },

        # @!attribute keystoreDetails
        #   @return [Jamf::SsoKeystoreDetails]
        keystoreDetails: {
          class: Jamf::SsoKeystoreDetails
        }

      } # end OAPI_PROPERTIES

    end # module SsoKeystoreResponseWithDetails
