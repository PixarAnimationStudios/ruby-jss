...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: InstallPackage
    #
    ...
    #  - OAPIObjectModels::PackageManifest
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::InstallPackage
    #
    module InstallPackage
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute manifest
        #   @return [Jamf::PackageManifest]
        manifest: {
          class: Jamf::PackageManifest,
          required: true
        },
