...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: SelfServiceSettings
    #
    ...
    #  - OAPIObjectModels::SelfServiceInstallSettings
    #  - OAPIObjectModels::SelfServiceLoginSettings
    #  - OAPIObjectModels::SelfServiceInteractionSettings
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::SelfServiceSettings
    #
    module SelfServiceSettings
      ...
      OAPI_PROPERTIES = {
        ...
        #   @return [Jamf::SelfServiceInstallSettings]
        installSettings: {
          class: Jamf::SelfServiceInstallSettings
        },

        # @!attribute loginSettings
        #   @return [Jamf::SelfServiceLoginSettings]
        loginSettings: {
          class: Jamf::SelfServiceLoginSettings
        },

        # @!attribute configurationSettings
        #   @return [Jamf::SelfServiceInteractionSettings]
        configurationSettings: {
          class: Jamf::SelfServiceInteractionSettings
        }

      } # end OAPI_PROPERTIES

    end # module SelfServiceSettings
