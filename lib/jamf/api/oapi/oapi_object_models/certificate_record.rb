...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: CertificateRecord
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::CertificateRecord
    #
    module CertificateRecord
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute signature
        #   @return [Jamf::Signature]
        signature: {
          class: Jamf::Signature
        },
