...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ComputerPartitionFileVault2State
    #
    ...
    #  - OAPIObjectModels::ComputerPartitionEncryption
    #
    # Sub Objects:
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ComputerPartitionFileVault2State
    #
    module ComputerPartitionFileVault2State

      # These enums are used in the properties below

      COMPUTER_PARTITION_FILE_VAULT2_STATE_OPTIONS = [
        'UNKNOWN',
        'UNENCRYPTED',
        'INELIGIBLE',
        'DECRYPTED',
    ...
    end # module ComputerPartitionFileVault2State
