...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: EnrollmentCustomizationDependencies
    #
    ...
    #  - OAPIObjectModels::EnrollmentCustomizationDependency
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/v1/sso/dependencies:GET', needs permissions: Read SSO Settings
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::EnrollmentCustomizationDependencies
    #
    module EnrollmentCustomizationDependencies
      ...
      OAPI_PROPERTIES = {
        ...
        #   @return [Array<Jamf::EnrollmentCustomizationDependency>]
        dependencies: {
          class: Jamf::EnrollmentCustomizationDependency,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module EnrollmentCustomizationDependencies
