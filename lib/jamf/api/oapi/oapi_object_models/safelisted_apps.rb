...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: SafelistedApps
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::ParentApp
    #  - OAPIObjectModels::TeacherSettingsRequest
    #  - OAPIObjectModels::TeacherSettingsResponse
    #
    # Sub Objects:
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::SafelistedApps
    #
    module SafelistedApps
