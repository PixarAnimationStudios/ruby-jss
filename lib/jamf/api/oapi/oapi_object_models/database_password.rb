...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: DatabasePassword
    #
    ...
    #  - '/system/initialize-database-connection:POST', needs permissions: Unknown
    #  - '/v1/system/initialize-database-connection:POST', needs permissions: Unknown
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::DatabasePassword
    #
