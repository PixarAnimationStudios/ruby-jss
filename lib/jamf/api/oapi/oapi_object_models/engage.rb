...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: Engage
    #
    ...
    #  - '/v1/engage:GET', needs permissions: Unknown
    #  - '/v1/engage:PUT', needs permissions: Update Engage Settings
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::Engage
    #
    module Engage
