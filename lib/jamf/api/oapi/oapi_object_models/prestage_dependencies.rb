...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: PrestageDependencies
    #
    ...
    #  - OAPIObjectModels::PrestageDependency
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::PrestageDependencies
    #
    module PrestageDependencies
      ...
      OAPI_PROPERTIES = {
        ...
        #   @return [Array<Jamf::PrestageDependency>]
        dependencies: {
          class: Jamf::PrestageDependency,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module PrestageDependencies
