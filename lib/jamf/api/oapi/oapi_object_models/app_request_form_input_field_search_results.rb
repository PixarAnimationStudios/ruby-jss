...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: AppRequestFormInputFieldSearchResults
    #
    ...
    #  - OAPIObjectModels::AppRequestFormInputField
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/v1/app-request/form-input-fields:GET', needs permissions: Read App Request Settings
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::AppRequestFormInputFieldSearchResults
    #
    module AppRequestFormInputFieldSearchResults
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::AppRequestFormInputField>]
        results: {
          class: Jamf::AppRequestFormInputField,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module AppRequestFormInputFieldSearchResults
