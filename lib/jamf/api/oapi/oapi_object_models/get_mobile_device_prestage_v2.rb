...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: GetMobileDevicePrestageV2
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::MobileDevicePrestageSearchResultsV2
    #
    # Sub Objects:
    ...
    #  - '/v2/mobile-device-prestages/{id}:GET', needs permissions: Read Mobile Device PreStage Enrollments
    #  - '/v2/mobile-device-prestages/{id}:PUT', needs permissions: Update Mobile Device PreStage Enrollments
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::GetMobileDevicePrestageV2
    #
    module GetMobileDevicePrestageV2
    ...
    end # module GetMobileDevicePrestageV2
