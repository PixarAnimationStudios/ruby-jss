...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: VolumePurchasingSubscriptions
    #
    ...
    #  - OAPIObjectModels::VolumePurchasingSubscription
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/v1/volume-purchasing-subscriptions:GET', needs permissions: Read Volume Purchasing Administrator Accounts
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::VolumePurchasingSubscriptions
    #
    module VolumePurchasingSubscriptions
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::VolumePurchasingSubscription>]
        results: {
          class: Jamf::VolumePurchasingSubscription,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module VolumePurchasingSubscriptions
