...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: PersonalHotspotSetting
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::PersonalHotspotSetting
    #
    module PersonalHotspotSetting

      # These enums are used in the properties below

      PERSONAL_HOTSPOT_SETTING_OPTIONS = [
    ...
    end # module PersonalHotspotSetting
