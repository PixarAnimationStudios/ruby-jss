...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: EnableLostModeCommand
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::EnableLostModeCommand
    #
    module EnableLostModeCommand
    ...
    end # module EnableLostModeCommand
