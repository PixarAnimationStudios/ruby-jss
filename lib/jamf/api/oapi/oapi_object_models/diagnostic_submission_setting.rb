...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: DiagnosticSubmissionSetting
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::SettingsCommand
    #
    # Sub Objects:
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::DiagnosticSubmissionSetting
    #
    module DiagnosticSubmissionSetting

      # These enums are used in the properties below

      DIAGNOSTIC_SUBMISSION_SETTING_OPTIONS = [
    ...
    end # module DiagnosticSubmissionSetting
