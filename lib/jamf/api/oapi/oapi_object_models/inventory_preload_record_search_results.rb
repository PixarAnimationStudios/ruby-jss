...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: InventoryPreloadRecordSearchResults
    #
    ...
    #  - OAPIObjectModels::InventoryPreloadRecord
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::InventoryPreloadRecordSearchResults
    #
    module InventoryPreloadRecordSearchResults
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::InventoryPreloadRecord>]
        results: {
    ...
    end # module InventoryPreloadRecordSearchResults
