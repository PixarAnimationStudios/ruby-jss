...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ComputerLicensedSoftware
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ComputerLicensedSoftware
    #
    module ComputerLicensedSoftware
    ...
    end # module ComputerLicensedSoftware
