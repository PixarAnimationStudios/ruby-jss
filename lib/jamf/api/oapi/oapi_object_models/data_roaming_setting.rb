...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: DataRoamingSetting
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::DataRoamingSetting
    #
    module DataRoamingSetting

      # These enums are used in the properties below

      DATA_ROAMING_SETTING_OPTIONS = [
        'ENABLE_DATA_ROAMING',
