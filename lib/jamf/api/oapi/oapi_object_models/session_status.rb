...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: SessionStatus
    #
    ...
    #  - '/preview/remote-administration-configurations/team-viewer/{configurationId}/sessions/{sessionId}/status:GET', needs permissions: Read Remote Administration
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::SessionStatus
    #
