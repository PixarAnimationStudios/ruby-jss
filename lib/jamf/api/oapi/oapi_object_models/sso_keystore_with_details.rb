...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: SsoKeystoreWithDetails
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::SsoKeystoreWithDetails
    #
    module SsoKeystoreWithDetails
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute keystore
        #   @return [Jamf::SsoKeystore]
        keystore: {
          class: Jamf::SsoKeystore
        },
    ...
    end # module SsoKeystoreWithDetails
