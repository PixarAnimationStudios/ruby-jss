...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: PlanSearchResults
    #
    ...
    #  - OAPIObjectModels::JamfProtectPlan
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/v1/jamf-protect/plans:GET', needs permissions: Read Jamf Protect Deployments
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::PlanSearchResults
    #
    module PlanSearchResults
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::JamfProtectPlan>]
        results: {
          class: Jamf::JamfProtectPlan,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module PlanSearchResults
