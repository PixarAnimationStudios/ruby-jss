...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ComputerGeneralUpdate
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ComputerGeneralUpdate
    #
    module ComputerGeneralUpdate
    ...
    end # module ComputerGeneralUpdate
