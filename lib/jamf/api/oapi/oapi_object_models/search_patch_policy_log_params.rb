...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: SearchPatchPolicyLogParams
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::SearchPatchPolicyLogParams
    #
    module SearchPatchPolicyLogParams
    ...
    end # module SearchPatchPolicyLogParams
