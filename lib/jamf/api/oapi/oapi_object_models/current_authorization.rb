...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: CurrentAuthorization
    #
    ...
    #  - OAPIObjectModels::CurrentAccount
    #  - OAPIObjectModels::Site
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/auth/current:POST', needs permissions: Unknown
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::CurrentAuthorization
    #
    module CurrentAuthorization
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute account
        #   @return [Jamf::CurrentAccount]
        account: {
          class: Jamf::CurrentAccount
        },

        # @!attribute sites
        #   @return [Array<Jamf::Site>]
        sites: {
          class: Jamf::Site,
          multi: true
        },
    ...
    end # module CurrentAuthorization
