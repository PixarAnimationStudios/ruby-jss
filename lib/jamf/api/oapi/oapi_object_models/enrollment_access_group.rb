...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: EnrollmentAccessGroup
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::AccessGroupsSearchResults
    #
    # Sub Objects:
    ...
    #  - '/v1/enrollment/access-groups/{group-key}:GET', needs permissions: Read User-Initiated Enrollment
    #  - '/v1/enrollment/access-groups/{group-key}:PUT', needs permissions: Update User-Initiated Enrollment
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::EnrollmentAccessGroup
    #
    module EnrollmentAccessGroup
    ...
    end # module EnrollmentAccessGroup
