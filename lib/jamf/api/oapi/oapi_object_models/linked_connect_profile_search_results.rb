...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: LinkedConnectProfileSearchResults
    #
    ...
    #  - OAPIObjectModels::LinkedConnectProfile
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/v1/jamf-connect/config-profiles:GET', needs permissions: Read Jamf Connect Deployments
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::LinkedConnectProfileSearchResults
    #
    module LinkedConnectProfileSearchResults
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::LinkedConnectProfile>]
        results: {
          class: Jamf::LinkedConnectProfile,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module LinkedConnectProfileSearchResults
