...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: MobileDeviceSearchResultsV2
    #
    ...
    #  - OAPIObjectModels::MobileDeviceV2
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/v2/mobile-devices:GET', needs permissions: Read Mobile Devices
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::MobileDeviceSearchResultsV2
    #
    module MobileDeviceSearchResultsV2
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::MobileDeviceV2>]
        results: {
          class: Jamf::MobileDeviceV2,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module MobileDeviceSearchResultsV2
