...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: VoiceRoamingSetting
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::VoiceRoamingSetting
    #
    module VoiceRoamingSetting

      # These enums are used in the properties below

      VOICE_ROAMING_SETTING_OPTIONS = [
    ...
    end # module VoiceRoamingSetting
