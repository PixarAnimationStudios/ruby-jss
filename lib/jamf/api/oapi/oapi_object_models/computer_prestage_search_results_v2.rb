...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ComputerPrestageSearchResultsV2
    #
    ...
    #  - OAPIObjectModels::GetComputerPrestageV2
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/v2/computer-prestages:GET', needs permissions: Read Computer PreStage Enrollments
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ComputerPrestageSearchResultsV2
    #
    module ComputerPrestageSearchResultsV2
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::GetComputerPrestageV2>]
        results: {
          class: Jamf::GetComputerPrestageV2,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module ComputerPrestageSearchResultsV2
