...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: AdvancedSearch
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::AdvancedSearchSearchResults
    #
    # Sub Objects:
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::AdvancedSearch
    #
