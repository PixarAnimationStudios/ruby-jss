...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: EnrollmentCustomizationPanelLdapAuth
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::EnrollmentCustomizationPanelLdapAuth
    #
    module EnrollmentCustomizationPanelLdapAuth
    ...
    end # module EnrollmentCustomizationPanelLdapAuth
