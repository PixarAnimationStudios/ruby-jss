...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: VenafiServiceStatus
    #
    ...
    #  - '/v1/pki/venafi/{id}/connection-status:GET', needs permissions: Read PKI
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::VenafiServiceStatus
    #
    module VenafiServiceStatus
    ...
    end # module VenafiServiceStatus
