...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: PutComputerPrestageV2
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::PutComputerPrestageV2
    #
    module PutComputerPrestageV2
    ...
    end # module PutComputerPrestageV2
