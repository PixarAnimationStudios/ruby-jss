...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: MobileDeviceSearchParams
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::MobileDeviceSearchParams
    #
    module MobileDeviceSearchParams
    ...
    end # module MobileDeviceSearchParams
