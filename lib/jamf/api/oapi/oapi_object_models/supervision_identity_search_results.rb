...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: SupervisionIdentitySearchResults
    #
    ...
    #  - OAPIObjectModels::SupervisionIdentity
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/v1/supervision-identities:GET', needs permissions: Read Apple Configurator Enrollment
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::SupervisionIdentitySearchResults
    #
    module SupervisionIdentitySearchResults
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::SupervisionIdentity>]
        results: {
          class: Jamf::SupervisionIdentity,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module SupervisionIdentitySearchResults
