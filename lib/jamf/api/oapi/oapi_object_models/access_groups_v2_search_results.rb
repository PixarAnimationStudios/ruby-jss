...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: AccessGroupsV2SearchResults
    #
    ...
    #  - OAPIObjectModels::EnrollmentAccessGroupV2
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/v2/enrollment/access-groups:GET', needs permissions: Read User-Initiated Enrollment
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::AccessGroupsV2SearchResults
    #
    module AccessGroupsV2SearchResults
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::EnrollmentAccessGroupV2>]
        results: {
          class: Jamf::EnrollmentAccessGroupV2,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module AccessGroupsV2SearchResults
