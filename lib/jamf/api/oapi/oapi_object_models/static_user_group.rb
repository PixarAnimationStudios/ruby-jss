...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: StaticUserGroup
    #
    ...
    #  - '/v1/static-user-groups:GET', needs permissions: Read Static User Groups
    #  - '/v1/static-user-groups/{id}:GET', needs permissions: Read Static User Groups
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::StaticUserGroup
    #
    module StaticUserGroup
