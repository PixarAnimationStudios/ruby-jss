...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: SupervisionIdentity
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::SupervisionIdentitySearchResults
    #
    # Sub Objects:
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::SupervisionIdentity
    #
    module SupervisionIdentity
    ...
    end # module SupervisionIdentity
