...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ParentApp
    #
    ...
    #  - '/v1/parent-app:GET', needs permissions: Read Parent App Settings
    #  - '/v1/parent-app:PUT', needs permissions: Update Parent App Settings
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ParentApp
    #
    module ParentApp
