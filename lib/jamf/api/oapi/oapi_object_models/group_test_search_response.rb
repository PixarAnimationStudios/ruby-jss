...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: GroupTestSearchResponse
    #
    ...
    #  - OAPIObjectModels::GroupTestSearch
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/v1/cloud-idp/{id}/test-group:POST', needs permissions: Read LDAP Servers
    #  - '/v1/cloud-ldaps/{id}/test-group:POST', needs permissions: Read LDAP Servers
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::GroupTestSearchResponse
    #
    module GroupTestSearchResponse
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::GroupTestSearch>]
        results: {
          class: Jamf::GroupTestSearch,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module GroupTestSearchResponse
