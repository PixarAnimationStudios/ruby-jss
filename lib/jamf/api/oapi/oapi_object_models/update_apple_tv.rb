...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: UpdateAppleTv
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::UpdateMobileDevice
    #
    # Sub Objects:
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::UpdateAppleTv
    #
    module UpdateAppleTv
