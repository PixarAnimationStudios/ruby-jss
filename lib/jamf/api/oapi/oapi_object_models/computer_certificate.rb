...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ComputerCertificate
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ComputerCertificate
    #
    module ComputerCertificate
    ...
    end # module ComputerCertificate
