...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: MobileDeviceAttachment
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::MobileDeviceAttachment
    #
    module MobileDeviceAttachment
    ...
    end # module MobileDeviceAttachment
