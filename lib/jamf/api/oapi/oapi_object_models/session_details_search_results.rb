...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: SessionDetailsSearchResults
    #
    ...
    #  - OAPIObjectModels::SessionDetails
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/preview/remote-administration-configurations/team-viewer/{configurationId}/sessions:GET', needs permissions: Read Remote Administration
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::SessionDetailsSearchResults
    #
    module SessionDetailsSearchResults
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::SessionDetails>]
        results: {
          class: Jamf::SessionDetails,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module SessionDetailsSearchResults
