...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: EbookScope
    #
    ...
    #  - OAPIObjectModels::EbookLimitations
    #  - OAPIObjectModels::EbookExclusions
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/v1/ebooks/{id}/scope:GET', needs permissions: Read eBooks
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::EbookScope
    #
    module EbookScope
      ...
      OAPI_PROPERTIES = {
        ...
        #   @return [Jamf::EbookLimitations]
        limitations: {
          class: Jamf::EbookLimitations
        },

        # @!attribute exclusions
        #   @return [Jamf::EbookExclusions]
        exclusions: {
          class: Jamf::EbookExclusions
        }

      } # end OAPI_PROPERTIES

    end # module EbookScope
