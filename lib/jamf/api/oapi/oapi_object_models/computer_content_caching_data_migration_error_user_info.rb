...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ComputerContentCachingDataMigrationErrorUserInfo
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ComputerContentCachingDataMigrationErrorUserInfo
    #
    module ComputerContentCachingDataMigrationErrorUserInfo
    ...
    end # module ComputerContentCachingDataMigrationErrorUserInfo
