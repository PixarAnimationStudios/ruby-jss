...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: GetMobileDevicePrestage
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::MobileDevicePrestageSearchResults
    #
    # Sub Objects:
    ...
    #  - '/v1/mobile-device-prestages:POST', needs permissions: Create Mobile Device PreStage Enrollments
    #  - '/v1/mobile-device-prestages/{id}:GET', needs permissions: Read Mobile Device PreStage Enrollments
    #  - '/v1/mobile-device-prestages/{id}:PUT', needs permissions: Update Mobile Device PreStage Enrollments
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::GetMobileDevicePrestage
    #
    module GetMobileDevicePrestage
    ...
    end # module GetMobileDevicePrestage
