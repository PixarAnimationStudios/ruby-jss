...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: PrestagePurchasingInformationV2
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::DeviceEnrollmentPrestageV2
    #
    # Sub Objects:
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::PrestagePurchasingInformationV2
    #
    module PrestagePurchasingInformationV2
    ...
    end # module PrestagePurchasingInformationV2
