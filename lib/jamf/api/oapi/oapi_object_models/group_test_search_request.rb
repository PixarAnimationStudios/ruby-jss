...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: GroupTestSearchRequest
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::GroupTestSearchRequest
    #
    module GroupTestSearchRequest
    ...
    end # module GroupTestSearchRequest
