...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: InventoryPreloadExtensionAttributeColumnResult
    #
    ...
    #  - OAPIObjectModels::InventoryPreloadExtensionAttributeColumn
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/v2/inventory-preload/ea-columns:GET', needs permissions: Read Inventory Preload Records
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::InventoryPreloadExtensionAttributeColumnResult
    #
    module InventoryPreloadExtensionAttributeColumnResult
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::InventoryPreloadExtensionAttributeColumn>]
        results: {
          class: Jamf::InventoryPreloadExtensionAttributeColumn,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module InventoryPreloadExtensionAttributeColumnResult
