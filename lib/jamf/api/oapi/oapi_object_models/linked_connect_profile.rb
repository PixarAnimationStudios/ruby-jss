...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: LinkedConnectProfile
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::LinkedConnectProfileSearchResults
    #
    # Sub Objects:
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::LinkedConnectProfile
    #
    module LinkedConnectProfile
    ...
    end # module LinkedConnectProfile
