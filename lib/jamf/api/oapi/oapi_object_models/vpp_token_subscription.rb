...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: VppTokenSubscription
    #
    ...
    #  - OAPIObjectModels::Recipients
    #  - OAPIObjectModels::AdminAccount
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::VppTokenSubscription
    #
    module VppTokenSubscription
      ...
      OAPI_PROPERTIES = {
        ...
        #   @return [Jamf::Recipients]
        recipients: {
          class: Jamf::Recipients
        },

        # @!attribute adminAccounts
        #   @return [Array<Jamf::AdminAccount>]
        adminAccounts: {
          class: Jamf::AdminAccount,
          multi: true
        },
    ...
    end # module VppTokenSubscription
