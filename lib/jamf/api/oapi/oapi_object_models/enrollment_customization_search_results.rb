...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: EnrollmentCustomizationSearchResults
    #
    ...
    #  - OAPIObjectModels::GetEnrollmentCustomization
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/v1/enrollment-customization:GET', needs permissions: Read Enrollment Customizations
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::EnrollmentCustomizationSearchResults
    #
    module EnrollmentCustomizationSearchResults
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::GetEnrollmentCustomization>]
        results: {
          class: Jamf::GetEnrollmentCustomization,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module EnrollmentCustomizationSearchResults
