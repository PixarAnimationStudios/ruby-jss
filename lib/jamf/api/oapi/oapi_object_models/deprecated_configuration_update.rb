...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: DeprecatedConfigurationUpdate
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::DeprecatedConfigurationUpdate
    #
    module DeprecatedConfigurationUpdate
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute server
        #   @return [Jamf::DeprecatedServerUpdate]
        server: {
          class: Jamf::DeprecatedServerUpdate,
          required: true
        },
    ...
    end # module DeprecatedConfigurationUpdate
