...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: SsoKeystoreCertParseResponse
    #
    ...
    #  - OAPIObjectModels::CertificateKey
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/v1/sso/cert/parse:POST', needs permissions: Update SSO Settings
    #  - '/v2/sso/cert/parse:POST', needs permissions: Update SSO Settings
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::SsoKeystoreCertParseResponse
    #
    module SsoKeystoreCertParseResponse
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute keys
        #   @return [Array<Jamf::CertificateKey>]
        keys: {
          class: Jamf::CertificateKey,
          multi: true
        },
    ...
    end # module SsoKeystoreCertParseResponse
