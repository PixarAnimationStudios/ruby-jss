...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ComputersSearchResults
    #
    ...
    #  - OAPIObjectModels::ComputerOverview
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/preview/computers:GET', needs permissions: Read Computers
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ComputersSearchResults
    #
    module ComputersSearchResults
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::ComputerOverview>]
        results: {
          class: Jamf::ComputerOverview,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module ComputersSearchResults
