...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: SoftwareUpdateSettings
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::SoftwareUpdateSettings
    #
    module SoftwareUpdateSettings
    ...
    end # module SoftwareUpdateSettings
