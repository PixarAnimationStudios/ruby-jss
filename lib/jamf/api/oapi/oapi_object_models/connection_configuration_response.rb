...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ConnectionConfigurationResponse
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ConnectionConfigurationResponse
    #
    module ConnectionConfigurationResponse
    ...
    end # module ConnectionConfigurationResponse
