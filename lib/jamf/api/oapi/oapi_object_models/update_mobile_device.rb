...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: UpdateMobileDevice
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::UpdateMobileDevice
    #
    module UpdateMobileDevice
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute ios
        #   @return [Jamf::UpdateIos]
        ios: {
          class: Jamf::UpdateIos
        },

        # @!attribute appleTv
        #   @return [Jamf::UpdateAppleTv]
        appleTv: {
          class: Jamf::UpdateAppleTv
        }

      } # end OAPI_PROPERTIES

    end # module UpdateMobileDevice
