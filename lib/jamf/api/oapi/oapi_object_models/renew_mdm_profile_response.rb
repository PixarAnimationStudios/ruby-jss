...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: RenewMdmProfileResponse
    #
    ...
    #  - OAPIObjectModels::Udids
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/v1/mdm/renew-profile:POST', needs permissions: Send Command to Renew MDM Profile
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::RenewMdmProfileResponse
    #
    module RenewMdmProfileResponse
    ...
    end # module RenewMdmProfileResponse
