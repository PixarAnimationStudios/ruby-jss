...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: PatchPolicyAttemptAction
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::PatchPolicyAttempt
    #
    # Sub Objects:
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::PatchPolicyAttemptAction
    #
    module PatchPolicyAttemptAction
    ...
    end # module PatchPolicyAttemptAction
