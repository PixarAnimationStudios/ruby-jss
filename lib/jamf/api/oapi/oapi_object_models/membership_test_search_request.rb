...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: MembershipTestSearchRequest
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::MembershipTestSearchRequest
    #
    module MembershipTestSearchRequest
    ...
    end # module MembershipTestSearchRequest
