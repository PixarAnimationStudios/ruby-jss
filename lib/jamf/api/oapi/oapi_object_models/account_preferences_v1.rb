...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: AccountPreferencesV1
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::AccountPreferencesV1
    #
    module AccountPreferencesV1
    ...
    end # module AccountPreferencesV1
