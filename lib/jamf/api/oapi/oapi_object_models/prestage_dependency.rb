...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: PrestageDependency
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::PrestageDependencies
    #
    # Sub Objects:
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::PrestageDependency
    #
    module PrestageDependency
