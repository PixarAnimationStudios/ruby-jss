...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: GetEnrollmentCustomizationPanelSsoAuth
    #
    ...
    #  - '/v1/enrollment-customization/{id}/sso:POST', needs permissions: Update Enrollment Customizations
    #  - '/v1/enrollment-customization/{id}/sso/{panel-id}:GET', needs permissions: Read Enrollment Customizations
    #  - '/v1/enrollment-customization/{id}/sso/{panel-id}:PUT', needs permissions: Update Enrollment Customizations
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::GetEnrollmentCustomizationPanelSsoAuth
    #
    module GetEnrollmentCustomizationPanelSsoAuth
    ...
    end # module GetEnrollmentCustomizationPanelSsoAuth
