...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: OrderBy
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::MobileDeviceSearchParams
    #  - OAPIObjectModels::SearchActivePatchHistoryParams
    #  - OAPIObjectModels::SearchPatchPolicyLogParams
    #
    # Sub Objects:
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::OrderBy
    #
    module OrderBy
