...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: RestartDeviceCommand
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::RestartDeviceCommand
    #
    module RestartDeviceCommand
    ...
    end # module RestartDeviceCommand
