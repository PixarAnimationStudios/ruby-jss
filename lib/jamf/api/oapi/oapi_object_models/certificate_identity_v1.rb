...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: CertificateIdentityV1
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::CertificateIdentityV1
    #
    module CertificateIdentityV1
    ...
    end # module CertificateIdentityV1
