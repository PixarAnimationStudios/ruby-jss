...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: MdmClientType
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::MdmClientType
    #
    module MdmClientType

      # These enums are used in the properties below

      MDM_CLIENT_TYPE_OPTIONS = [
        'MOBILE_DEVICE',
        'TV',
        'COMPUTER',
        'COMPUTER_USER',
