...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: AzureServerConfiguration
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::AzureConfiguration
    #
    # Sub Objects:
    # Other object models used by this model's attributes.
    #  - OAPIObjectModels::AzureMappings
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/v1/cloud-azure/defaults/server-configuration:GET', needs permissions: Read LDAP Servers
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::AzureServerConfiguration
    #
    module AzureServerConfiguration
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute mappings
        #   @return [Jamf::AzureMappings]
        mappings: {
          class: Jamf::AzureMappings,
          required: true
        },
    ...
    end # module AzureServerConfiguration
