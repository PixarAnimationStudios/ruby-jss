...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ComputerAttachment
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ComputerAttachment
    #
    module ComputerAttachment
