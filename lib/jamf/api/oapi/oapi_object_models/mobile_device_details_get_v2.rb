...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: MobileDeviceDetailsGetV2
    #
    ...
    #  - '/v2/mobile-devices/{id}/detail:GET', needs permissions: Read Mobile Devices
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::MobileDeviceDetailsGetV2
    #
    module MobileDeviceDetailsGetV2
    ...
    end # module MobileDeviceDetailsGetV2
