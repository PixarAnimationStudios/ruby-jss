...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: MobileDeviceCertificateV1
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::MobileDeviceCertificateV1
    #
    module MobileDeviceCertificateV1
    ...
    end # module MobileDeviceCertificateV1
