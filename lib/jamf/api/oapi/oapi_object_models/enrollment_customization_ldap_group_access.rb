...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: EnrollmentCustomizationLdapGroupAccess
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::EnrollmentCustomizationLdapGroupAccess
    #
    module EnrollmentCustomizationLdapGroupAccess
    ...
    end # module EnrollmentCustomizationLdapGroupAccess
