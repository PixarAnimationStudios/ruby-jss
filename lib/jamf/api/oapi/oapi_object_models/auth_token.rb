...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: AuthToken
    #
    ...
    #  - '/auth/keepAlive:POST', needs permissions: Unknown
    #  - '/auth/tokens:POST', needs permissions: Unknown
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::AuthToken
    #
    module AuthToken
