...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ConnectionConfigurationCandidateRequest
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ConnectionConfigurationCandidateRequest
    #
    module ConnectionConfigurationCandidateRequest
    ...
    end # module ConnectionConfigurationCandidateRequest
