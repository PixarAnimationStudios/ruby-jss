...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ComputerPackageReceipts
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ComputerPackageReceipts
    #
    module ComputerPackageReceipts
    ...
    end # module ComputerPackageReceipts
