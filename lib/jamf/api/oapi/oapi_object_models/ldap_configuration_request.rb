...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: LdapConfigurationRequest
    #
    ...
    #  - OAPIObjectModels::CloudIdPCommonRequest
    #  - OAPIObjectModels::CloudLdapServerRequest
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::LdapConfigurationRequest
    #
    module LdapConfigurationRequest
      ...
      OAPI_PROPERTIES = {
        ...
        #   @return [Jamf::CloudIdPCommonRequest]
        cloudIdPCommon: {
          class: Jamf::CloudIdPCommonRequest,
          required: true
        },

        # @!attribute server
        #   @return [Jamf::CloudLdapServerRequest]
        server: {
          class: Jamf::CloudLdapServerRequest,
          required: true
        },
    ...
    end # module LdapConfigurationRequest
