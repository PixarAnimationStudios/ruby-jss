...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: MdmSigningCertificate
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::EnrollmentSettings
    #
    # Sub Objects:
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::MdmSigningCertificate
    #
    module MdmSigningCertificate
    ...
    end # module MdmSigningCertificate
