...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ApplicationAttributes
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ApplicationAttributes
    #
    module ApplicationAttributes
      ...
      OAPI_PROPERTIES = {
        ...
        #   @return [Jamf::Attributes]
        attributes: {
          class: Jamf::Attributes
        }

      } # end OAPI_PROPERTIES

    end # module ApplicationAttributes
