...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: MobileDevicePrestageName
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::MobileDevicePrestageNames
    #
    # Sub Objects:
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::MobileDevicePrestageName
    #
    module MobileDevicePrestageName
    ...
    end # module MobileDevicePrestageName
