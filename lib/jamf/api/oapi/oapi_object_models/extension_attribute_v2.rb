...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ExtensionAttributeV2
    #
    ...
    #  - OAPIObjectModels::UpdateMobileDeviceV2
    #
    # Sub Objects:
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ExtensionAttributeV2
    #
    module ExtensionAttributeV2
    ...
    end # module ExtensionAttributeV2
