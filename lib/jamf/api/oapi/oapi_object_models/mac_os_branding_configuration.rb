...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: MacOsBrandingConfiguration
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::MacOsBrandingSearchResults
    #
    # Sub Objects:
    ...
    #  - '/v1/self-service/branding/macos/{id}:GET', needs permissions: Read Self Service Branding Configuration
    #  - '/v1/self-service/branding/macos/{id}:PUT', needs permissions: Update Self Service Branding Configuration
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::MacOsBrandingConfiguration
    #
    module MacOsBrandingConfiguration
    ...
    end # module MacOsBrandingConfiguration
