...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: PrestageScopeV2
    #
    ...
    #  - '/v2/computer-prestages/scope:GET', needs permissions: Read Computer PreStage Enrollments
    #  - '/v2/mobile-device-prestages/scope:GET', needs permissions: Read Mobile Device PreStage Enrollments
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::PrestageScopeV2
    #
    module PrestageScopeV2
