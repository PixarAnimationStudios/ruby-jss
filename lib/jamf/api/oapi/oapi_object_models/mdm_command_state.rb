...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: MdmCommandState
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::MdmCommandState
    #
    module MdmCommandState

      # These enums are used in the properties below

      MDM_COMMAND_STATE_OPTIONS = [
        'PENDING',
        'ACKNOWLEDGED',
        'NOT_NOW',
        'ERROR'
