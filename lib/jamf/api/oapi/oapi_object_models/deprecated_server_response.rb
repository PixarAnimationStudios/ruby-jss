...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: DeprecatedServerResponse
    #
    ...
    #  - '/v1/cloud-ldaps/defaults/server-configuration:GET', needs permissions: Read LDAP Servers
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::DeprecatedServerResponse
    #
    module DeprecatedServerResponse
    ...
    end # module DeprecatedServerResponse
