...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: MobileDeviceApplication
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::MobileDeviceApplication
    #
    module MobileDeviceApplication
    ...
    end # module MobileDeviceApplication
