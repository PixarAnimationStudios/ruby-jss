...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: DeprecatedConfigurationSearchResults
    #
    ...
    #  - '/v1/cloud-ldaps:GET', needs permissions: Read LDAP Servers
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::DeprecatedConfigurationSearchResults
    #
    module DeprecatedConfigurationSearchResults
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::DeprecatedConfigurationResponse>]
        results: {
          class: Jamf::DeprecatedConfigurationResponse,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module DeprecatedConfigurationSearchResults
