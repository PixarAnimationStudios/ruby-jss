...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: MobileDevicePrestageSearchResults
    #
    ...
    #  - OAPIObjectModels::GetMobileDevicePrestage
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/v1/mobile-device-prestages:GET', needs permissions: Read Mobile Device PreStage Enrollments
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::MobileDevicePrestageSearchResults
    #
    module MobileDevicePrestageSearchResults
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::GetMobileDevicePrestage>]
        results: {
          class: Jamf::GetMobileDevicePrestage,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module MobileDevicePrestageSearchResults
