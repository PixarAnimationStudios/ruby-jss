...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: PatchPolicyAttempt
    #
    ...
    #  - OAPIObjectModels::PatchPolicyAttemptAction
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/patch/patch-policies/{id}/logs:GET', needs permissions: Read Patch Policies
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::PatchPolicyAttempt
    #
    module PatchPolicyAttempt
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute actions
        #   @return [Array<Jamf::PatchPolicyAttemptAction>]
        actions: {
          class: Jamf::PatchPolicyAttemptAction,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module PatchPolicyAttempt
