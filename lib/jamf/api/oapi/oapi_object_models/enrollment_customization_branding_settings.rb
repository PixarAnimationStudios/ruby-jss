...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: EnrollmentCustomizationBrandingSettings
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::EnrollmentCustomization
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::EnrollmentCustomizationBrandingSettings
    #
    module EnrollmentCustomizationBrandingSettings
    ...
    end # module EnrollmentCustomizationBrandingSettings
