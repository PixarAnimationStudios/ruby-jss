...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: PutComputerPrestage
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::PutComputerPrestage
    #
    module PutComputerPrestage
    ...
    end # module PutComputerPrestage
