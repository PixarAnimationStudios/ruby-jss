...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: VolumePurchasingLocation
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::VolumePurchasingLocation
    #
    module VolumePurchasingLocation
    ...
    end # module VolumePurchasingLocation
