...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: GetEnrollmentCustomizationPanel
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::EnrollmentCustomizationPanelList
    #
    # Sub Objects:
    ...
    #  - '/v1/enrollment-customization/{id}/all/{panel-id}:GET', needs permissions: Read Enrollment Customizations
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::GetEnrollmentCustomizationPanel
    #
    module GetEnrollmentCustomizationPanel
    ...
    end # module GetEnrollmentCustomizationPanel
