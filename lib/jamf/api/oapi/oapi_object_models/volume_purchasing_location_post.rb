...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: VolumePurchasingLocationPost
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::VolumePurchasingLocationPost
    #
    module VolumePurchasingLocationPost
    ...
    end # module VolumePurchasingLocationPost
