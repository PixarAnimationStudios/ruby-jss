...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: DeprecatedServerUpdate
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::DeprecatedServerUpdate
    #
    module DeprecatedServerUpdate
    ...
    end # module DeprecatedServerUpdate
