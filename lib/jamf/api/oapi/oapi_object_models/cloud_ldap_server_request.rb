...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: CloudLdapServerRequest
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::CloudLdapServerRequest
    #
    module CloudLdapServerRequest
    ...
    end # module CloudLdapServerRequest
