...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: EnrollmentCustomizationPanelList
    #
    ...
    #  - OAPIObjectModels::GetEnrollmentCustomizationPanel
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/v1/enrollment-customization/{id}/all:GET', needs permissions: Read Enrollment Customizations
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::EnrollmentCustomizationPanelList
    #
    module EnrollmentCustomizationPanelList
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute panels
        #   @return [Array<Jamf::GetEnrollmentCustomizationPanel>]
        panels: {
          class: Jamf::GetEnrollmentCustomizationPanel,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module EnrollmentCustomizationPanelList
