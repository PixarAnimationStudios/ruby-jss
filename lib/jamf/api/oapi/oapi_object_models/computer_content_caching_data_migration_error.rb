...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ComputerContentCachingDataMigrationError
    #
    ...
    #  - OAPIObjectModels::ComputerContentCachingDataMigrationErrorUserInfo
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ComputerContentCachingDataMigrationError
    #
    module ComputerContentCachingDataMigrationError
      ...
      OAPI_PROPERTIES = {
        ...
        #   @return [Array<Jamf::ComputerContentCachingDataMigrationErrorUserInfo>]
        userInfo: {
          class: Jamf::ComputerContentCachingDataMigrationErrorUserInfo,
          readonly: true,
          multi: true
        }
    ...
    end # module ComputerContentCachingDataMigrationError
