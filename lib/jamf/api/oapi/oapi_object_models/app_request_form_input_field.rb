...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: AppRequestFormInputField
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::AppRequestFormInputFieldSearchResults
    #
    # Sub Objects:
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::AppRequestFormInputField
    #
    module AppRequestFormInputField
    ...
    end # module AppRequestFormInputField
