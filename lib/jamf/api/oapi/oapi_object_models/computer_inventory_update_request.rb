...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ComputerInventoryUpdateRequest
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ComputerInventoryUpdateRequest
    #
    module ComputerInventoryUpdateRequest
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute general
        #   @return [Jamf::ComputerGeneralUpdate]
        general: {
          class: Jamf::ComputerGeneralUpdate
        },
        ...
        # @!attribute hardware
        #   @return [Jamf::ComputerHardwareUpdate]
        hardware: {
          class: Jamf::ComputerHardwareUpdate
        },

        # @!attribute operatingSystem
        #   @return [Jamf::ComputerOperatingSystemUpdate]
        operatingSystem: {
          class: Jamf::ComputerOperatingSystemUpdate
        },
    ...
    end # module ComputerInventoryUpdateRequest
