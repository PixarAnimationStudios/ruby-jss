...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ComputerConfigurationProfile
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ComputerConfigurationProfile
    #
    module ComputerConfigurationProfile
    ...
    end # module ComputerConfigurationProfile
