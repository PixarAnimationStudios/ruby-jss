...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: NotificationV1
    #
    ...
    #  - OAPIObjectModels::NotificationType
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::NotificationV1
    #
    module NotificationV1
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute type
        #   @return [Jamf::NotificationType]
        type: {
          class: Jamf::NotificationType
        },
