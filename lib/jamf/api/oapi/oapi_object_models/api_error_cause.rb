...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ApiErrorCause
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ApiErrorCause
    #
    module ApiErrorCause
