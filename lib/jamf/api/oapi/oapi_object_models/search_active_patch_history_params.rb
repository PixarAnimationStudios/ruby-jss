...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: SearchActivePatchHistoryParams
    #
    ...
    #  - OAPIObjectModels::OrderBy
    #  - OAPIObjectModels::Filter
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::SearchActivePatchHistoryParams
    #
    module SearchActivePatchHistoryParams
    ...
    end # module SearchActivePatchHistoryParams
