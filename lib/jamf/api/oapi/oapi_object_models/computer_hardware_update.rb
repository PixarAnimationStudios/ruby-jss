...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ComputerHardwareUpdate
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ComputerHardwareUpdate
    #
    module ComputerHardwareUpdate
    ...
    end # module ComputerHardwareUpdate
