...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: DeviceEnrollmentInstance
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::DeviceEnrollmentInstanceSearchResults
    #
    # Sub Objects:
    ...
    #  - '/v1/device-enrollments/{id}:GET', needs permissions: Read Device Enrollment Program Instances
    #  - '/v1/device-enrollments/{id}:PUT', needs permissions: Update Device Enrollment Program Instances
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::DeviceEnrollmentInstance
    #
    module DeviceEnrollmentInstance
    ...
    end # module DeviceEnrollmentInstance
