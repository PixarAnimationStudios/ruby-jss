...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: InventoryPreloadRecordSearchResultsV2
    #
    ...
    #  - OAPIObjectModels::InventoryPreloadRecordV2
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/v2/inventory-preload/records:GET', needs permissions: Read Inventory Preload Records
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::InventoryPreloadRecordSearchResultsV2
    #
    module InventoryPreloadRecordSearchResultsV2
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::InventoryPreloadRecordV2>]
        results: {
          class: Jamf::InventoryPreloadRecordV2,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module InventoryPreloadRecordSearchResultsV2
