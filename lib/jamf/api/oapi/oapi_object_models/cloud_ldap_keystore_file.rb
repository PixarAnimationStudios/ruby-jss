...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: CloudLdapKeystoreFile
    #
    ...
    #  - OAPIObjectModels::DeprecatedServerRequest
    #  - OAPIObjectModels::DeprecatedServerUpdate
    #
    # Sub Objects:
    ...
    #  - '/v1/ldap-keystore/verify:POST', needs permissions: Create LDAP Servers
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::CloudLdapKeystoreFile
    #
    module CloudLdapKeystoreFile
    ...
    end # module CloudLdapKeystoreFile
