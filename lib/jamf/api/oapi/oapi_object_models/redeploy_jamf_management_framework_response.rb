...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: RedeployJamfManagementFrameworkResponse
    #
    ...
    #  - '/v1/jamf-management-framework/redeploy/{id}:POST', needs permissions: Send Computer Remote Command to Install Package
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::RedeployJamfManagementFrameworkResponse
    #
    module RedeployJamfManagementFrameworkResponse
    ...
    end # module RedeployJamfManagementFrameworkResponse
