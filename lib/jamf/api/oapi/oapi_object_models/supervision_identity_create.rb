...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: SupervisionIdentityCreate
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::SupervisionIdentityCreate
    #
    module SupervisionIdentityCreate
    ...
    end # module SupervisionIdentityCreate
