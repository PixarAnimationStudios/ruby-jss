...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: UserTestSearch
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::UserTestSearchResponse
    #
    # Sub Objects:
    # Other object models used by this model's attributes.
    #  - OAPIObjectModels::UserAttributes
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::UserTestSearch
    #
    module UserTestSearch
      ...
      OAPI_PROPERTIES = {
        ...
        #   @return [Jamf::UserAttributes]
        attributes: {
          class: Jamf::UserAttributes
        }

      } # end OAPI_PROPERTIES

    end # module UserTestSearch
