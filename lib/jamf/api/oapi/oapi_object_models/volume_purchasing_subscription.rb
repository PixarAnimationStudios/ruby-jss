...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: VolumePurchasingSubscription
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::VolumePurchasingSubscriptions
    #
    # Sub Objects:
    ...
    #  - '/v1/volume-purchasing-subscriptions/{id}:GET', needs permissions: Read Volume Purchasing Administrator Accounts
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::VolumePurchasingSubscription
    #
    module VolumePurchasingSubscription
    ...
    end # module VolumePurchasingSubscription
