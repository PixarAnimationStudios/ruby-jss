...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: AdvancedSearchCriteriaChoices
    #
    ...
    #  - '/v1/advanced-mobile-device-searches/choices:GET', needs permissions: Read Advanced Mobile Device Searches
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::AdvancedSearchCriteriaChoices
    #
    module AdvancedSearchCriteriaChoices
    ...
    end # module AdvancedSearchCriteriaChoices
