...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: PatchPolicyOnDashboard
    #
    ...
    #  - '/patch/patch-policies/{id}/dashboard:GET', needs permissions: Read Patch Policies
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::PatchPolicyOnDashboard
    #
    module PatchPolicyOnDashboard
    ...
    end # module PatchPolicyOnDashboard
