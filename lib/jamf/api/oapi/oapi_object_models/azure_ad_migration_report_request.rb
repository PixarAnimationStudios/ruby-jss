...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: AzureAdMigrationReportRequest
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::AzureAdMigrationReportRequest
    #
    module AzureAdMigrationReportRequest
    ...
    end # module AzureAdMigrationReportRequest
