...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: EnrollmentCustomization
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::EnrollmentCustomization
    #
    module EnrollmentCustomization
    ...
    end # module EnrollmentCustomization
