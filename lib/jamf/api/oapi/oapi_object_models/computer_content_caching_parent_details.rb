...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ComputerContentCachingParentDetails
    #
    ...
    #  - OAPIObjectModels::ComputerContentCachingParentCapabilities
    #  - OAPIObjectModels::ComputerContentCachingParentLocalNetwork
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ComputerContentCachingParentDetails
    #
    module ComputerContentCachingParentDetails
      ...
      OAPI_PROPERTIES = {
        ...
        #   @return [Jamf::ComputerContentCachingParentCapabilities]
        capabilities: {
          class: Jamf::ComputerContentCachingParentCapabilities
        },
        ...
        #   @return [Array<Jamf::ComputerContentCachingParentLocalNetwork>]
        localNetwork: {
          class: Jamf::ComputerContentCachingParentLocalNetwork,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module ComputerContentCachingParentDetails
