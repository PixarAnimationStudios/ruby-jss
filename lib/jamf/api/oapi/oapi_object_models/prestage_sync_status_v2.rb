...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: PrestageSyncStatusV2
    #
    ...
    #  - '/v2/mobile-device-prestages/syncs:GET', needs permissions: Read Mobile Device PreStage Enrollments
    #  - '/v2/mobile-device-prestages/{id}/syncs:GET', needs permissions: Read Mobile Device PreStage Enrollments
    #  - '/v2/mobile-device-prestages/{id}/syncs/latest:GET', needs permissions: Read Mobile Device PreStage Enrollments
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::PrestageSyncStatusV2
    #
    module PrestageSyncStatusV2
    ...
    end # module PrestageSyncStatusV2
