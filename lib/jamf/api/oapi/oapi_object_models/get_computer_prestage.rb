...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: GetComputerPrestage
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::ComputerPrestageSearchResults
    #
    # Sub Objects:
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::GetComputerPrestage
    #
    module GetComputerPrestage
    ...
    end # module GetComputerPrestage
