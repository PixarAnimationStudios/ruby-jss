...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: CertificateIdentityV2
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::EnrollmentSettingsV2
    #  - OAPIObjectModels::EnrollmentSettingsV2
    #
    # Sub Objects:
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::CertificateIdentityV2
    #
    module CertificateIdentityV2
    ...
    end # module CertificateIdentityV2
