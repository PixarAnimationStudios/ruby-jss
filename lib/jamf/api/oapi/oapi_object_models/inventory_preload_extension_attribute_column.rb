...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: InventoryPreloadExtensionAttributeColumn
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::InventoryPreloadExtensionAttributeColumnResult
    #
    # Sub Objects:
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::InventoryPreloadExtensionAttributeColumn
    #
    module InventoryPreloadExtensionAttributeColumn
    ...
    end # module InventoryPreloadExtensionAttributeColumn
