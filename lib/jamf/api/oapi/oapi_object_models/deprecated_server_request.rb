...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: DeprecatedServerRequest
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::DeprecatedServerRequest
    #
    module DeprecatedServerRequest
    ...
    end # module DeprecatedServerRequest
