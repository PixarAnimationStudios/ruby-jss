...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: DeviceComplianceInformation
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::DeviceComplianceInformation
    #
    module DeviceComplianceInformation
    ...
    end # module DeviceComplianceInformation
