...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: EnrollmentCustomizationPanelSsoAuth
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::EnrollmentCustomizationPanelSsoAuth
    #
    module EnrollmentCustomizationPanelSsoAuth
    ...
    end # module EnrollmentCustomizationPanelSsoAuth
