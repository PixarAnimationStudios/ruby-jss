...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: AdvancedSearchSearchResults
    #
    ...
    #  - OAPIObjectModels::AdvancedSearch
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::AdvancedSearchSearchResults
    #
    module AdvancedSearchSearchResults
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::AdvancedSearch>]
        results: {
    ...
    end # module AdvancedSearchSearchResults
