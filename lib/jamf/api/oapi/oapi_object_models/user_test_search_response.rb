...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: UserTestSearchResponse
    #
    ...
    #  - OAPIObjectModels::UserTestSearch
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::UserTestSearchResponse
    #
    module UserTestSearchResponse
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::UserTestSearch>]
        results: {
          class: Jamf::UserTestSearch,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module UserTestSearchResponse
