...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: MobileDevicePrestage
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::MobileDevicePrestage
    #
    module MobileDevicePrestage
    ...
    end # module MobileDevicePrestage
