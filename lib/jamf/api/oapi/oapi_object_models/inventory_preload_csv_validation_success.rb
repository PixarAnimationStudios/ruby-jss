...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: InventoryPreloadCsvValidationSuccess
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::InventoryPreloadCsvValidationSuccess
    #
    module InventoryPreloadCsvValidationSuccess
    ...
    end # module InventoryPreloadCsvValidationSuccess
