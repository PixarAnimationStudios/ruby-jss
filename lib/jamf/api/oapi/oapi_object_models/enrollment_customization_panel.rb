...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: EnrollmentCustomizationPanel
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::EnrollmentCustomizationPanel
    #
    module EnrollmentCustomizationPanel
    ...
    end # module EnrollmentCustomizationPanel
