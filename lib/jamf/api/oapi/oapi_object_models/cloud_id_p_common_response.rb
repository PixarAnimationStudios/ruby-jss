...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: CloudIdPCommonResponse
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::ConfigurationSearchResults
    #
    # Sub Objects:
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::CloudIdPCommonResponse
    #
    module CloudIdPCommonResponse
    ...
    end # module CloudIdPCommonResponse
