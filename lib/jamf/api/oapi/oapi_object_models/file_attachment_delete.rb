...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: FileAttachmentDelete
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::FileAttachmentDelete
    #
    module FileAttachmentDelete
    ...
    end # module FileAttachmentDelete
