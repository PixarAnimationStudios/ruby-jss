...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: CloudLdapMappingsRequest
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::DeprecatedConfigurationRequest
    #  - OAPIObjectModels::DeprecatedConfigurationUpdate
    #  - OAPIObjectModels::LdapConfigurationRequest
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::CloudLdapMappingsRequest
    #
    module CloudLdapMappingsRequest
    ...
    end # module CloudLdapMappingsRequest
