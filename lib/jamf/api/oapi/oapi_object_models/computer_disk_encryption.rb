...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ComputerDiskEncryption
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ComputerDiskEncryption
    #
    module ComputerDiskEncryption
      ...
      OAPI_PROPERTIES = {
        ...
        #   @return [Jamf::ComputerPartitionEncryption]
        bootPartitionEncryptionDetails: {
          class: Jamf::ComputerPartitionEncryption
        },
    ...
    end # module ComputerDiskEncryption
