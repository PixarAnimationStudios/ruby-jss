...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ComputerRemoteManagement
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ComputerRemoteManagement
    #
    module ComputerRemoteManagement
    ...
    end # module ComputerRemoteManagement
