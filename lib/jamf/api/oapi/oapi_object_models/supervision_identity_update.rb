...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: SupervisionIdentityUpdate
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::SupervisionIdentityUpdate
    #
    module SupervisionIdentityUpdate
    ...
    end # module SupervisionIdentityUpdate
