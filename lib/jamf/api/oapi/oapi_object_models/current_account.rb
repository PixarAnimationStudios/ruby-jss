...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: CurrentAccount
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::CurrentAuthorization
    #
    # Sub Objects:
    # Other object models used by this model's attributes.
    #  - OAPIObjectModels::AccountPreferences
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::CurrentAccount
    #
    module CurrentAccount
      ...
      OAPI_PROPERTIES = {
        ...
        #   @return [Jamf::AccountPreferences]
        preferences: {
