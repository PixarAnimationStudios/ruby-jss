...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: AccessGroupsSearchResults
    #
    ...
    #  - OAPIObjectModels::EnrollmentAccessGroup
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/v1/enrollment/access-groups:GET', needs permissions: Read User-Initiated Enrollment
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::AccessGroupsSearchResults
    #
    module AccessGroupsSearchResults
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::EnrollmentAccessGroup>]
        results: {
          class: Jamf::EnrollmentAccessGroup,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module AccessGroupsSearchResults
