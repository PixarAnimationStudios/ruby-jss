...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: DeviceEnrollmentDisownBody
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::DeviceEnrollmentDisownBody
    #
    module DeviceEnrollmentDisownBody
    ...
    end # module DeviceEnrollmentDisownBody
