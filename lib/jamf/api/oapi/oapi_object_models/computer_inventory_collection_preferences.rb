...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ComputerInventoryCollectionPreferences
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::ComputerInventoryCollectionSettings
    #
    # Sub Objects:
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ComputerInventoryCollectionPreferences
    #
    module ComputerInventoryCollectionPreferences
    ...
    end # module ComputerInventoryCollectionPreferences
