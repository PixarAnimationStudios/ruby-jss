...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ClientCheckInV3
    #
    ...
    #  - '/v3/check-in:GET', needs permissions: Read Computer Check-In
    #  - '/v3/check-in:PUT', needs permissions: Update Computer Check-In
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ClientCheckInV3
    #
    module ClientCheckInV3
