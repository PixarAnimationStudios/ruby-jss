...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: AccountPreferencesV4
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::AccountPreferencesV4
    #
    module AccountPreferencesV4
    ...
    end # module AccountPreferencesV4
