...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ComputerPartition
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ComputerPartition
    #
    module ComputerPartition
