...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: MobileDeviceV2
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::MobileDeviceSearchResultsV2
    #
    # Sub Objects:
    ...
    #  - '/v2/mobile-devices/{id}:GET', needs permissions: Read Mobile Devices
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::MobileDeviceV2
    #
    module MobileDeviceV2
