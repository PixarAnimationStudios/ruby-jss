...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: GetEnrollmentCustomization
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::EnrollmentCustomizationSearchResults
    #
    # Sub Objects:
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::GetEnrollmentCustomization
    #
    module GetEnrollmentCustomization
    ...
    end # module GetEnrollmentCustomization
