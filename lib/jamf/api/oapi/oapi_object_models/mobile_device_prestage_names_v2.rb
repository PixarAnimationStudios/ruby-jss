...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: MobileDevicePrestageNamesV2
    #
    ...
    #  - OAPIObjectModels::MobileDevicePrestageNameV2
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::MobileDevicePrestageNamesV2
    #
    module MobileDevicePrestageNamesV2
      ...
      OAPI_PROPERTIES = {
        ...
        #   @return [Array<Jamf::MobileDevicePrestageNameV2>]
        prestageDeviceNames: {
          class: Jamf::MobileDevicePrestageNameV2,
          multi: true
        },
    ...
    end # module MobileDevicePrestageNamesV2
