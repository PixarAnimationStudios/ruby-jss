...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ComputerSoftwareUpdate
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ComputerSoftwareUpdate
    #
    module ComputerSoftwareUpdate
    ...
    end # module ComputerSoftwareUpdate
