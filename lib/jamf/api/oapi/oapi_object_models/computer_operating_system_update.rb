...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ComputerOperatingSystemUpdate
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ComputerOperatingSystemUpdate
    #
    module ComputerOperatingSystemUpdate
    ...
    end # module ComputerOperatingSystemUpdate
