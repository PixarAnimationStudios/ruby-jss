...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: PrestagePurchasingInformation
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::DeviceEnrollmentPrestage
    #
    # Sub Objects:
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::PrestagePurchasingInformation
    #
    module PrestagePurchasingInformation
    ...
    end # module PrestagePurchasingInformation
