...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: PrestageFileAttachmentV2
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::PrestageFileAttachmentV2
    #
    module PrestageFileAttachmentV2
    ...
    end # module PrestageFileAttachmentV2
