...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: CertificateKey
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::SsoKeystoreCertParseResponse
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::CertificateKey
    #
    module CertificateKey
