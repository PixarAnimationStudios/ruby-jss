...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ComputerUserAndLocation
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ComputerUserAndLocation
    #
    module ComputerUserAndLocation
    ...
    end # module ComputerUserAndLocation
