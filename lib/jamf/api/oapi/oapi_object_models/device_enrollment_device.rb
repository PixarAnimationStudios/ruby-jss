...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: DeviceEnrollmentDevice
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::DeviceEnrollmentDeviceSearchResults
    #
    # Sub Objects:
    # Other object models used by this model's attributes.
    #  - OAPIObjectModels::AssignRemoveProfileResponseSyncState
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::DeviceEnrollmentDevice
    #
    module DeviceEnrollmentDevice
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute syncState
        #   @return [Jamf::AssignRemoveProfileResponseSyncState]
        syncState: {
          class: Jamf::AssignRemoveProfileResponseSyncState
        },
    ...
    end # module DeviceEnrollmentDevice
