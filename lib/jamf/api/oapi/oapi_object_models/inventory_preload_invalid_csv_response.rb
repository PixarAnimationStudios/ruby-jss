...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: InventoryPreloadInvalidCsvResponse
    #
    ...
    #  - OAPIObjectModels::InventoryPreloadCsvError
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::InventoryPreloadInvalidCsvResponse
    #
    module InventoryPreloadInvalidCsvResponse
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute errors
        #   @return [Array<Jamf::InventoryPreloadCsvError>]
        errors: {
          class: Jamf::InventoryPreloadCsvError,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module InventoryPreloadInvalidCsvResponse
