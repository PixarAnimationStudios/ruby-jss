...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: DeprecatedConfigurationRequest
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::DeprecatedConfigurationRequest
    #
    module DeprecatedConfigurationRequest
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute server
        #   @return [Jamf::DeprecatedServerRequest]
        server: {
          class: Jamf::DeprecatedServerRequest,
          required: true
        },
    ...
    end # module DeprecatedConfigurationRequest
