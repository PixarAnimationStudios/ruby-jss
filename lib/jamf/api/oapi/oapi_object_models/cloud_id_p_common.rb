...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: CloudIdPCommon
    #
    ...
    #  - '/v1/cloud-idp/{id}:GET', needs permissions: Read LDAP Servers
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::CloudIdPCommon
    #
    module CloudIdPCommon
