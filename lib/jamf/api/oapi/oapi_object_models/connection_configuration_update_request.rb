...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ConnectionConfigurationUpdateRequest
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ConnectionConfigurationUpdateRequest
    #
    module ConnectionConfigurationUpdateRequest
    ...
    end # module ConnectionConfigurationUpdateRequest
