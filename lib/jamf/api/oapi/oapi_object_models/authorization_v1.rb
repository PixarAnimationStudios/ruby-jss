...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: AuthorizationV1
    #
    ...
    #  - OAPIObjectModels::AuthAccountV1
    ...
    module AuthorizationV1
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute account
        #   @return [Jamf::AuthAccountV1]
        account: {
          class: Jamf::AuthAccountV1
        },
