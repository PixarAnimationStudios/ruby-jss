...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: RecalculationResults
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::RecalculationResults
    #
    module RecalculationResults
    ...
    end # module RecalculationResults
