...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: CloudLdapConnectionStatus
    #
    ...
    #  - '/v2/cloud-ldaps/{id}/connection/status:GET', needs permissions: Read LDAP Servers
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::CloudLdapConnectionStatus
    #
    module CloudLdapConnectionStatus
    ...
    end # module CloudLdapConnectionStatus
