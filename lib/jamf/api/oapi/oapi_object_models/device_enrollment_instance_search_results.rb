...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: DeviceEnrollmentInstanceSearchResults
    #
    ...
    #  - OAPIObjectModels::DeviceEnrollmentInstance
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/v1/device-enrollments:GET', needs permissions: Read Device Enrollment Program Instances
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::DeviceEnrollmentInstanceSearchResults
    #
    module DeviceEnrollmentInstanceSearchResults
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::DeviceEnrollmentInstance>]
        results: {
          class: Jamf::DeviceEnrollmentInstance,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module DeviceEnrollmentInstanceSearchResults
