...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ActivePatchHistorySearchResults
    #
    ...
    #  - OAPIObjectModels::ActivePatchHistory
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/patch/searchActivePatchHistory:POST', needs permissions: Read Patch Management Software Titles
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ActivePatchHistorySearchResults
    #
    module ActivePatchHistorySearchResults
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::ActivePatchHistory>]
        results: {
          class: Jamf::ActivePatchHistory,
          multi: true
        },
    ...
    end # module ActivePatchHistorySearchResults
