...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ActivePatchHistory
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::ActivePatchHistorySearchResults
    #
    # Sub Objects:
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ActivePatchHistory
    #
    module ActivePatchHistory
