...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: MdmCommandRequest
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::MdmCommandRequest
    #
    module MdmCommandRequest
      ...
      OAPI_PROPERTIES = {
        ...
        #   @return [Array<Jamf::MdmCommandClient>]
        clientData: {
