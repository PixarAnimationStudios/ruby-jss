...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: PutMobileDevicePrestageV2
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::PutMobileDevicePrestageV2
    #
    module PutMobileDevicePrestageV2
    ...
    end # module PutMobileDevicePrestageV2
