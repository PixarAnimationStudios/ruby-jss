...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: Markdown
    #
    ...
    #  - '/v1/enrollment-customization/parse-markdown:POST', needs permissions: Read Enrollment Customizations
    #  - '/v1/enrollment-customization/{id}/text/{panel-id}/markdown:GET', needs permissions: Read Enrollment Customizations
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::Markdown
    #
    module Markdown
