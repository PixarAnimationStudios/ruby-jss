...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: UpdateMobileDeviceV2
    #
    ...
    #  - OAPIObjectModels::UpdateIosV2
    #  - OAPIObjectModels::UpdateTvOs
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::UpdateMobileDeviceV2
    #
    module UpdateMobileDeviceV2
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute ios
        #   @return [Jamf::UpdateIosV2]
        ios: {
          class: Jamf::UpdateIosV2
        },

        # @!attribute tvos
        #   @return [Jamf::UpdateTvOs]
        tvos: {
          class: Jamf::UpdateTvOs
        }

      } # end OAPI_PROPERTIES

    end # module UpdateMobileDeviceV2
