...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: DeploymentTaskSearchResults
    #
    ...
    #  - OAPIObjectModels::DeploymentTask
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/v1/jamf-connect/deployments/{id}/tasks:GET', needs permissions: Read Jamf Connect Deployments
    #  - '/v1/jamf-protect/deployments/{id}/tasks:GET', needs permissions: Read Jamf Protect Deployments
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::DeploymentTaskSearchResults
    #
    module DeploymentTaskSearchResults
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::DeploymentTask>]
        results: {
          class: Jamf::DeploymentTask,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module DeploymentTaskSearchResults
