...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: JamfPackageResponse
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::JamfApplicationResponse
    #
    # Sub Objects:
    ...
    #  - '/v1/jamf-package:GET', needs permissions: Jamf Packages Action
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::JamfPackageResponse
    #
    module JamfPackageResponse
    ...
    end # module JamfPackageResponse
