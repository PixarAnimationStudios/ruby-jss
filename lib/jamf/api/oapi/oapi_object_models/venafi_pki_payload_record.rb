...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: VenafiPkiPayloadRecord
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::VenafiPkiPayloadRecordSearchResults
    #
    # Sub Objects:
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::VenafiPkiPayloadRecord
    #
    module VenafiPkiPayloadRecord
    ...
    end # module VenafiPkiPayloadRecord
