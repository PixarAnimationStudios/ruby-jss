...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: AzureServerConfigurationUpdate
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::AzureConfigurationUpdate
    #
    # Sub Objects:
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::AzureServerConfigurationUpdate
    #
    module AzureServerConfigurationUpdate
    ...
    end # module AzureServerConfigurationUpdate
