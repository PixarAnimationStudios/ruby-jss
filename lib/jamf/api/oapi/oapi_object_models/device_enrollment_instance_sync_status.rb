...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: DeviceEnrollmentInstanceSyncStatus
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::DeviceEnrollmentInstanceSyncStatus
    #
    module DeviceEnrollmentInstanceSyncStatus
    ...
    end # module DeviceEnrollmentInstanceSyncStatus
