...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: SessionCandidateRequest
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::SessionCandidateRequest
    #
    module SessionCandidateRequest
    ...
    end # module SessionCandidateRequest
