...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ComputerMdmCapability
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ComputerMdmCapability
    #
    module ComputerMdmCapability
    ...
    end # module ComputerMdmCapability
