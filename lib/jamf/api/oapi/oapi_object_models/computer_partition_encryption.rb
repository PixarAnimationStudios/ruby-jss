...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ComputerPartitionEncryption
    #
    ...
    #  - OAPIObjectModels::ComputerPartitionFileVault2State
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ComputerPartitionEncryption
    #
    module ComputerPartitionEncryption
      ...
      OAPI_PROPERTIES = {
        ...
        #   @return [Jamf::ComputerPartitionFileVault2State]
        partitionFileVault2State: {
          class: Jamf::ComputerPartitionFileVault2State
        },
    ...
    end # module ComputerPartitionEncryption
