...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: InventoryPreloadExtensionAttribute
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::InventoryPreloadExtensionAttribute
    #
    module InventoryPreloadExtensionAttribute
    ...
    end # module InventoryPreloadExtensionAttribute
