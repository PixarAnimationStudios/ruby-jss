...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: VolumePurchasingLocations
    #
    ...
    #  - OAPIObjectModels::VolumePurchasingLocationListView
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/v1/volume-purchasing-locations:GET', needs permissions: Read Volume Purchasing Administrator Accounts
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::VolumePurchasingLocations
    #
    module VolumePurchasingLocations
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::VolumePurchasingLocationListView>]
        results: {
          class: Jamf::VolumePurchasingLocationListView,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module VolumePurchasingLocations
