...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: AssignRemoveProfileResponseSyncState
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::AssignRemoveProfileResponseSyncState
    #
    module AssignRemoveProfileResponseSyncState
    ...
    end # module AssignRemoveProfileResponseSyncState
