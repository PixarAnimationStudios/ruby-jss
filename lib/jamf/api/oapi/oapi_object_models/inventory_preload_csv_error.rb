...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: InventoryPreloadCsvError
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::InventoryPreloadInvalidCsvResponse
    #
    # Sub Objects:
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::InventoryPreloadCsvError
    #
    module InventoryPreloadCsvError
    ...
    end # module InventoryPreloadCsvError
