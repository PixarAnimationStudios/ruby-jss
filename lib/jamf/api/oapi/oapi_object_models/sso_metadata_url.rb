...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: SsoMetadataUrl
    #
    ...
    #  - '/v1/sso/validate:POST', needs permissions: Update SSO Settings
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::SsoMetadataUrl
    #
    module SsoMetadataUrl
