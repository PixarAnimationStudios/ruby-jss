...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ComputerContentCachingCacheDetail
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ComputerContentCachingCacheDetail
    #
    module ComputerContentCachingCacheDetail
    ...
    end # module ComputerContentCachingCacheDetail
