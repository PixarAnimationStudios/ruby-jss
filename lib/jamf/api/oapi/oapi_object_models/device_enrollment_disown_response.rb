...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: DeviceEnrollmentDisownResponse
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::DeviceEnrollmentDisownResponse
    #
    module DeviceEnrollmentDisownResponse
    ...
    end # module DeviceEnrollmentDisownResponse
