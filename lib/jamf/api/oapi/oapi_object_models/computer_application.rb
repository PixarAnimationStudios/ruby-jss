...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ComputerApplication
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ComputerApplication
    #
    module ComputerApplication
    ...
    end # module ComputerApplication
