...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: MobileDevicePrestageSearchResultsV2
    #
    ...
    #  - OAPIObjectModels::GetMobileDevicePrestageV2
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/v2/mobile-device-prestages:GET', needs permissions: Read Mobile Device PreStage Enrollments
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::MobileDevicePrestageSearchResultsV2
    #
    module MobileDevicePrestageSearchResultsV2
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::GetMobileDevicePrestageV2>]
        results: {
          class: Jamf::GetMobileDevicePrestageV2,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module MobileDevicePrestageSearchResultsV2
