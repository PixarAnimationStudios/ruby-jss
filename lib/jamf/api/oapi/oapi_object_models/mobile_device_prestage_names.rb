...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: MobileDevicePrestageNames
    #
    ...
    #  - OAPIObjectModels::MobileDevicePrestageName
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::MobileDevicePrestageNames
    #
    module MobileDevicePrestageNames
      ...
      OAPI_PROPERTIES = {
        ...
        #   @return [Array<Jamf::MobileDevicePrestageName>]
        prestageDeviceNames: {
    ...
    end # module MobileDevicePrestageNames
