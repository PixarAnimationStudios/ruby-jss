...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: PrestageSyncStatus
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::PrestageSyncStatus
    #
    module PrestageSyncStatus
