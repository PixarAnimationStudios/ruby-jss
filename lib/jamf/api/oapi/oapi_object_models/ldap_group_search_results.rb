...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: LdapGroupSearchResults
    #
    ...
    #  - OAPIObjectModels::LdapGroup
    #
    # Endpoints and Privileges:
    # API endpoints and HTTP operations that use this object
    # model, and the Jamf Pro privileges needed to access them.
    #  - '/ldap/groups:GET', needs permissions: Read LDAP Servers
    #  - '/v1/ldap/groups:GET', needs permissions: Read LDAP Servers
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::LdapGroupSearchResults
    #
    module LdapGroupSearchResults
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::LdapGroup>]
        results: {
          class: Jamf::LdapGroup,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # module LdapGroupSearchResults
