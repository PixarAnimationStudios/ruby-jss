...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: PutMobileDevicePrestage
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::PutMobileDevicePrestage
    #
    module PutMobileDevicePrestage
    ...
    end # module PutMobileDevicePrestage
