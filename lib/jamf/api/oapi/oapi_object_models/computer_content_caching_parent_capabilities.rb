...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ComputerContentCachingParentCapabilities
    #
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ComputerContentCachingParentCapabilities
    #
    module ComputerContentCachingParentCapabilities
    ...
    end # module ComputerContentCachingParentCapabilities
