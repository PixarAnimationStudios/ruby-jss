...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: FileAttachmentV2
    #
    ...
    #  - '/v2/mobile-device-prestages/{id}/attachments:GET', needs permissions: Read Mobile Device PreStage Enrollments
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::FileAttachmentV2
    #
    module FileAttachmentV2
