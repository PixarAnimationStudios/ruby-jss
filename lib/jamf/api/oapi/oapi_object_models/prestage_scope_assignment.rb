...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: PrestageScopeAssignment
    #
    ...
    # of their attributes.
    #  - OAPIObjectModels::PrestageScopeResponse
    #
    # Sub Objects:
    ...
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::PrestageScopeAssignment
    #
    module PrestageScopeAssignment
    ...
    end # module PrestageScopeAssignment
