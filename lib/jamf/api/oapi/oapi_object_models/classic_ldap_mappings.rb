...
module Jamf
  ...
  module OAPIObjectModels
    ...
    # API Object Model and Enums for: ClassicLdapMappings
    #
    ...
    #  - '/v1/classic-ldap/{id}:GET', needs permissions: Read LDAP Servers
    #
    # We define this in its own module so that it can be autoloaded
    # by ZeitWerk, and included in other classes and modules.
    #
    # To do so, use:
    #   include Jamf::OAPIObjectModels::ClassicLdapMappings
    #
    module ClassicLdapMappings
    ...
    end # module ClassicLdapMappings
