...
module JSS
  ...
  # An active PatchVersion in the JSS.
  #
  # This class corresponds to a "version" returned from the 'patches' resource of
  # the API
  #
  # Not only does each one have a 'version', e.g. '8.3.2b12', but
  # also knows its parent PatchTitle, the id of the matching JSS::Package, if any
  # and the names and ids of the computers that have it installed.
  #
  # To set or change the JSS::Package associated with a PatchVersion, first fetch
  # the corresponding PatchTitle, specifying the version you want to change,
